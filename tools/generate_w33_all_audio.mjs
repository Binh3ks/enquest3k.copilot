...
const STATIC_AUDIO_TASKS = [
  ...
  { filename: 'explore.mp3', text: 'Around the world, schools have different safety traditions. In Japan, children clean their hallways together every afternoon so floors stay dry and clean. In Finland, students wear indoor soft shoes to prevent slipping on smooth wooden tiles. Working together makes school safe for everyone.', voice: 'en-US-Journey-F' }
];
