...
const BLUEPRINT_WEEKS = {
  ...
  29: {
    theme: "Off We Go! Airport Journey",
    grammar: "Irregular Verbs 1 Movement: go-went, come-came, run-ran, fly-flew",
    keywords: "airport, journey, plane, departure, arrival, luggage, gate, ticket, flew, went, came, ran",
    video_hint: "irregular verbs past tense went ran came flew kids song",
    read_topic: "Lily's family flies from Hanoi to Da Nang — airport journey irregular verbs"
  },
  30: {
    theme: "The Picnic",
