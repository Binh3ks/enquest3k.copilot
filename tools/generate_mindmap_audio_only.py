#!/usr/bin/env python3
"""
Generate ONLY mindmap audio files for Week 3
Fixes the issue where audio URLs were being read by TTS
"""
...
def main():
    ...
    data_path = root_dir / "src" / "data" / "weeks" / week_id_str / "mindmap.js"
    audio_dir = root_dir / "public" / "audio" / f"week{week}"
    ...
    print(f"\n📝 Extracting text from {data_path.name}...")
