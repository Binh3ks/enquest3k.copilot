 ...
 *
 * USAGE:
 *   node tools/validate_sgmath_types.mjs 33        # validate week 33
 *   node tools/validate_sgmath_types.mjs 33 easy   # validate easy mode only
 *   node tools/validate_sgmath_types.mjs 33 adv    # validate advanced only
 *   node tools/validate_sgmath_types.mjs --all     # validate all deployed weeks
 *
