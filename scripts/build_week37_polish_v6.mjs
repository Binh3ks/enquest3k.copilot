...
console.log('🚀 Building Polished Pipeline V6 for Week 37 (Clean Math Formula & Natural Contextual Saturday Morning)...');
...
// Social Studies EASY (148w, 10 bolds) — Natural transition for Saturday morning
const easyReadSocialEn = `Long ago in ancient Greece, people gathered at Olympia for the first Olympic Games. Leaders **declared a sacred truce** so athletes could travel without danger. **First of all**, leaders **sat down with their coaches** to stop all wars and share peace. Runners **ran very fast** on the track and **passed the Olympic torch** together. Today, the Modern Olympic Games connect children from over two hundred countries. For example, on a sunny **Saturday morning**, teams **went to the sports stadium** with bright flags. Athletes **marched across the stadium** and **represented their home nations** with big smiles. Families **watched and clapped** for every runner. **At the very end**, all athletes **were united in peace** because **sports brought peace** to the world. Children **smiled with pride** for global friendship.`;
...
const easyReadData = `export default {
  ...
  read_social: {
    ...
    content_vi: \`Ngày xưa ở Hy Lạp cổ đại, mọi người tập hợp tại Olympia tham gia Thế vận hội Olympic đầu tiên. Các nhà lãnh đạo tuyên bố thỏa thuận ngừng bắn linh thiêng để các vận động viên đi lại an toàn. Trước tiên, các đối thủ ngồi xuống với nhà huấn luyện để dừng các cuộc chiến và chia sẻ hòa bình. Người chạy chạy rất nhanh và cùng nhau truyền ngọn đốc Olympic. Ngày nay, Thế vận hội Olympic hiện đại kết nối trẻ em từ hơn 200 quốc gia. Ví dụ, vào một sáng thứ Bảy nắng đẹp, các đội đến sân vận động với lá cờ rực rỡ. Các vận động viên diễu hành và đại diện cho quốc gia với nụ cười lớn. Gia đình xem và vỗ tay. Cuối cùng, tất cả vận động viên đoàn kết trong hòa bình vì thể thao mang lại hòa bình cho thế giới. Trẻ em mỉm cười tự hào vì tình hữu nghị toàn cầu.\`,
    key_vocabulary: [
...
console.log('✅ Successfully wrote Polished V6 read.js for ADV & EASY!');
