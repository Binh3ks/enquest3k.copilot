...
export const speakingHub = {
  ...
  picture_story: {
    ...
    images: [
      ...
      { id: 4, image_url: "/images/week${weekNum}/webtoon_scene_4.png", narrator_prompt: "Later, hunters trapped the lion, and the brave mouse chewed the ropes to free him." }
    ]
  },
  personal_questions: {
