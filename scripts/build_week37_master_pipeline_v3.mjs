...
console.log('🚀 Building Week 37 Master Pipeline V3...');
...
// ============================================================================
// 1. STEM STORY & SOCIAL STUDIES PASSAGES (Clean readable text, no raw LaTeX escapes)
// ============================================================================

// STEM Story ADV (~180w, 10 bolds)
...
// STEM Story EASY (~150w, 10 bolds) — Simplified, readable, no raw LaTeX escapes
const easyReadStemEn = `On **Saturday morning**, Leo and his happy classmates **went to the sports stadium** to study speed science and run outdoors. Running **was warm and bright** in the fresh morning sunlight, giving oxygen energy to their leg muscles. **First of all**, Leo decided to enter the competitive 100-metre relay race. He **sat down with his coach** before the event to calculate their running speed (speed = distance / time). When the starting whistle blew, Leo **ran very fast** down the red track and **passed the baton** cleanly to Maya. Leg muscles convert food energy into quick movement. Maya **ran across the grass** with great speed to reach the next zone. Max **caught the baton** smoothly and sprinted quickly toward the finish line. All the cheering friends **watched and clapped** with big proud smiles. **At the very end**, their relay team crossed the line first! They **were tired but happy** because scientific **teamwork brought victory**. Leo felt very proud when receiving his gold medal.`;
...
const easyReadData = `export default {
  ...
  read_stem: {
    ...
    comprehension_questions: [
      ...
      { id: 2, question_en: "What speed formula did Leo calculate?", answer: ["speed = distance / time"], clue_statement: "Leo calculated speed = distance / time.", hint_en: "speed = ...", hint_vi: "tốc độ = ..." },
      { id: 3, question_en: "Who caught the baton smoothly from Maya?", answer: ["Max"], clue_statement: "Max caught the baton smoothly.", hint_en: "Max...", hint_vi: "Bạn Max..." }
    ]
  },
  read_social: {
...
console.log('✅ Wrote ADV & EASY read.js with simplified, clean STEM science passages!');


// ============================================================================
// 2. SHADOWING: TTS Mode (Reading Summary) vs Video Mode (bXtm-iBtsPo - Unused Video)
// ============================================================================

const shadowingDataADV = {
  videoId: 'bXtm-iBtsPo', // UNUSED video: Nina watched second graders run outside for school games!
  ...
  script: [
    ...
    { id: 2, text: "The weather was sunny and warm for outdoor running.", vi: "Thời tiết nắng và ấm áp cho việc chạy bộ ngoài trời." },
    ...
    { id: 8, text: "Max caught the baton smoothly and sprinted toward the line.", vi: "Max đã bắt lấy gậy mượt mà và bứt tốc về vạch đích." },
    { id: 9, text: "Spectators watched and clapped enthusiastically.", vi: "Khán giả đã xem và vỗ tay nhiệt tình." },
    { id: 10, text: "At the very end, their team crossed the line first!", vi: "Cuối cùng, đội của họ đã cán đích đầu tiên!" },
    { id: 11, text: "Everyone were tired but happy because teamwork brought victory.", vi: "Mọi người mệt nhưng vui vì tinh thần đồng đội mang lại chiến thắng." },
...
console.log('✅ Updated shadowing.js with TTS reading summary & unused video bXtm-iBtsPo!');


// ============================================================================
// 3. AI TUTOR: CONCISE OPENING NARRATIVES FOR 0MS TTS LATENCY + 2 FREE TALK CARDS
// ============================================================================
...
console.log('✅ Wrote concise 0ms latency week_37_real.js!');
