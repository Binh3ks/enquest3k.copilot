...
| **Hub 1** | 📝 Fill Blanks | Popover Dropdown | 1 Đoạn văn 10 chỗ trống + 1 Tiêu đề | Bẫy từ loại và thì quá khứ |
| **Hub 1** | 🕵️ Detective | Split Screen UI | 1 Bài đọc 5 câu trích xuất | Trích xuất chính xác 1-4 từ gốc |
...
---
**Bản Blueprint đã được kiểm duyệt, tinh chỉnh chính xác 100% và ĐÃ ĐÓNG BĂNG (LOCKED) làm tiêu chuẩn sản xuất Master W33 & W34+!**
