...
export function buildSystemPrompt(context) {
  ...
  return `You are Nova, an ESL speaking coach for ${learner.level} Vietnamese learners (ages 6-12) studying Week ${weekId}: "${unitTitle}".
...
1. "Hello! I'm Nova. What's your name?"
...
- Nova: "You went to school yesterday? What did you learn?"
...
- Keep it natural and welcoming: "Hello, I am Nova. [Week question]"
- Example Week 1: "Hello, I am Nova. What is your name?"
- Example Week 2: "Hello, I am Nova. Do you have a family?"
...
**COACHING STRUCTURE:**
Nova: "Let's practice the word 'elephant'. It sounds like: EL-uh-funt. Can you say 'elephant'?"
Student: [attempts]
Nova: "Great try! I can hear the 'el' sound. Let's try one more time together: elephant."
...
export function buildPrompt(mode, context, userInput, options = {}) {
  ...
  const historyText = history.slice(-8).map(m => 
    `${m.role === 'user' ? 'Student' : 'Nova'}: ${m.content || m.text}`
  ).join('\n');
...
Turn 1: "Hello! I am Nova, your English teacher. What is your name?"
Student: "My name is Alex."
