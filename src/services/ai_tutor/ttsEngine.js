...
function cleanTextForSpeech(text) {
  ...
  return text
    ...
    .replace(/\*([^*]+)\*/g, '$1')
    .replace(/_([^_]+)_/g, '$1')
    // Fix homograph "live": verb /lɪv/ (reside) vs adjective /laɪv/ (live show)
    // Replace verb form (preceded by subject pronoun) with "liv" to force short-i pronunciation
    .replace(/\b(I|we|they|you|students?|children|people)\s+live\b/gi, '$1 liv')
