...
const DB_NAME = 'EngQuestTTSCache_v16';
const STORE_NAME = 'tts_audio';
const DB_VERSION = 1;  // Fresh v16 store (Aug 7, 2026): 100% fresh clean cache with period-padded crisp final consonants (/t/, /d/, /er/)
