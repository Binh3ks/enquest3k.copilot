...
import { Send, Bot, X, BrainCircuit, Mic, MicOff, Loader2, MessageCircle, Volume2, Play, Shuffle, BookText, Sword, PenTool, Award, CheckCircle, XCircle, RotateCcw, Calculator, FlaskConical, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="fixed bottom-6 right-6 w-[440px] h-[720px] bg-white rounded-[40px] shadow-2xl flex flex-col z-[100] border-4 border-indigo-50 overflow-hidden animate-in slide-in-from-right duration-300">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-slate-50/50">
        ...
        {activeTab === 'chat' && chatMessages.length === 0 && (
          <div className="flex flex-col items-center justify-center py-10 px-6 text-center animate-in fade-in zoom-in duration-500">
            ...
            <p className="text-xs text-slate-600 mt-2 leading-relaxed">
              I'm your witty and patient ESL tutor. 
              Choose a tab above to start our English adventure!
            </p>
          </div>
        )}
        ...
        {/* STORY MISSION TAB (NEW V4 - Rebuilt) */}
        {activeTab === 'story' && (
          <NovaStoryTab 
            weekData={weekData}
