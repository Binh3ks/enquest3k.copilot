  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4 sm:p-6 bg-white text-slate-800 rounded-3xl border border-slate-200 shadow-xl font-sans">
      ...
      {activeTab === 'webtoon' ? (
        ...
        /* CHECK MODE: LIGHTWEIGHT WEEKLY CAMBRIDGE READING MINI-CHECK (OPEN CLOZE 5 GAPS) */
        <div className="space-y-4 animate-in fade-in">
          <div className="p-4 bg-amber-50 border border-amber-300 rounded-2xl flex items-center justify-between text-amber-900 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-black">🎯 WEEKLY CHECK MODE (MINI READING TEST): Fill 5 missing words from memory without hints! (5 Gaps • Cambridge Part 6 Standard)</span>
            </div>
