...
import { week20GamesAdvanced } from '../data/weeks/week_20/games.js';
import { week20GamesEasy } from '../data/weeks_easy/week_20/games.js';
import { week21GamesAdvanced } from '../data/weeks/week_21/games.js';
import { week21GamesEasy } from '../data/weeks_easy/week_21/games.js';
import { week22GamesAdvanced } from '../data/weeks/week_22/games.js';
import { week22GamesEasy } from '../data/weeks_easy/week_22/games.js';
import { week23GamesAdvanced } from '../data/weeks/week_23/games.js';
import { week23GamesEasy } from '../data/weeks_easy/week_23/games.js';
import { week24GamesAdvanced } from '../data/weeks/week_24/games.js';
import { week24GamesEasy } from '../data/weeks_easy/week_24/games.js';
import { week25GamesAdvanced } from '../data/weeks/week_25/games.js';
import { week25GamesEasy } from '../data/weeks_easy/week_25/games.js';
import { week26GamesAdvanced } from '../data/weeks/week_26/games.js';
import { week27GamesAdvanced } from '../data/weeks/week_27/games.js';
import { week28GamesAdvanced } from '../data/weeks/week_28/games.js';
import { week26GamesEasy } from '../data/weeks_easy/week_26/games.js';
import { week27GamesEasy } from '../data/weeks_easy/week_27/games.js';
import { week28GamesEasy } from '../data/weeks_easy/week_28/games.js';
import { week29GamesAdvanced } from '../data/weeks/week_29/games.js';
import { week29GamesEasy } from '../data/weeks_easy/week_29/games.js';
import { week30GamesAdvanced } from '../data/weeks/week_30/games.js';
import { week30GamesEasy } from '../data/weeks_easy/week_30/games.js';
import { week31GamesAdvanced } from '../data/weeks/week_31/games.js';
import { week31GamesEasy } from '../data/weeks_easy/week_31/games.js';
import { week32GamesAdvanced } from '../data/weeks/week_32/games.js';
import { week32GamesEasy } from '../data/weeks_easy/week_32/games.js';
...
import week20RealData from '../data/weeks/week_20_real.js';
import week21RealData from '../data/weeks/week_21_real.js';
import week22RealData from '../data/weeks/week_22_real.js';
import week23RealData from '../data/weeks/week_23_real.js';
import week24RealData from '../data/weeks/week_24_real.js';
import week25RealData from '../data/weeks/week_25_real.js';
import week26RealData from '../data/weeks/week_26_real.js';
import week27RealData from '../data/weeks/week_27/week_27_real.js';
import week28RealData from '../data/weeks/week_28_real.js';
import week29RealData from '../data/weeks/week_29/week_29_real.js';
import week30RealData from '../data/weeks/week_30/week_30_real.js';
import week31RealData from '../data/weeks/week_31/week_31_real.js';
import week32RealData from '../data/weeks/week_32/week_32_real.js';
...
export function getGameData(weekNumber, learningMode = 'advanced', gameId) {
  const weekGamesMap = {
    ...
    20: { advanced: week20GamesAdvanced, easy: week20GamesEasy },
    21: { advanced: week21GamesAdvanced, easy: week21GamesEasy },
    22: { advanced: week22GamesAdvanced, easy: week22GamesEasy },
    23: { advanced: week23GamesAdvanced, easy: week23GamesEasy },
    24: { advanced: week24GamesAdvanced, easy: week24GamesEasy },
    25: { advanced: week25GamesAdvanced, easy: week25GamesEasy },
    26: { advanced: week26GamesAdvanced, easy: week26GamesEasy },
    27: { advanced: week27GamesAdvanced, easy: week27GamesEasy },
    28: { advanced: week28GamesAdvanced, easy: week28GamesEasy },
    29: { advanced: week29GamesAdvanced, easy: week29GamesEasy },
    30: { advanced: week30GamesAdvanced, easy: week30GamesEasy },
    31: { advanced: week31GamesAdvanced, easy: week31GamesEasy },
    32: { advanced: week32GamesAdvanced, easy: week32GamesEasy },
