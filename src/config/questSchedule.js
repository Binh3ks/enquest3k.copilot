...
export const QUEST_SCHEDULE = [
  {
    ...
    label: '📖 Story World',
    quests: [
      { id: 'gear1_webtoon',  label: 'Scene Explorer',   zone: 1, gearIndex: 0, station: null,              icon: '📚', minutes: 8 },
      { id: 'gear2_karaoke',  label: 'Voice Shadow',     zone: 1, gearIndex: 1, station: null,              icon: '🎧', minutes: 7 },
      { id: 'gear3_retell',   label: 'Story Retell',     zone: 1, gearIndex: 2, station: null,              icon: '🎙️', minutes: 8 },
    ],
  },
  {
    day: 2,
    label: '🔬 Knowledge Lab',
    quests: [
      { id: 'gear4_clil',     label: 'Fact Finder',      zone: 1, gearIndex: 3, station: null,              icon: '🌐', minutes: 8 },
      { id: 'science_lab',    label: 'Action Lab',       zone: 2, gearIndex: null, station: 'science_lab',  icon: '🧪', minutes: 6 },
      { id: 'science_report', label: 'Discovery Report', zone: 3, gearIndex: null, station: 'science_report', icon: '📝', minutes: 7 },
    ],
  },
  {
    day: 3,
    ...
    quests: [
      { id: 'word_blitz',     label: 'Speed Match',      zone: 2, gearIndex: null, station: 'word_blitz',     icon: '⚡', minutes: 5 },
  ...
  },
  {
    ...
    label: '🏰 Boss Castle',
    quests: [
      { id: 'boss_listening', label: 'Listening Shield',          zone: 4, gearIndex: null, station: 'listening_boss', icon: '🎧', minutes: 10 },
      { id: 'boss_reading',   label: 'Reading & Writing Shield',  zone: 4, gearIndex: null, station: 'rw_boss',        icon: '📖', minutes: 10 },
      { id: 'weekly_review',  label: 'Speaking & Passport',       zone: 4, gearIndex: null, station: 'review',         icon: '🏆', minutes: 15 },
    ],
  },
];
