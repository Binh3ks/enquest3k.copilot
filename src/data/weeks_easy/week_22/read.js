...
Cô ấy **hỏi về hôm qua** sáng và nghi phạm **đã làm gì đêm** qua. Cô ấy cũng hỏi về những sự kiện **từ tuần trước**. Nghi phạm **nhớ mọi thứ rõ ràng**.

Nova **kiểm tra mọi** manh mối **trong sổ của cô** cẩn thận. Sau đó cô ấy **viết báo cáo cuối** cùng và **giải quyết** case! Giỏi lắm, thám tử Nova!",
  audio_url: "/audio/week22_easy/read_main.mp3",
  comprehension_questions: [
    { id: 1, question_en: "What did Detective Nova have?", answer: ["A case", "A case to solve", "A notebook and a case"], clue_statement: "Detective Nova have a notebook and a case.", hint_en: "She had a...", hint_vi: "Cô ấy có một..." },
    ...
    { id: 3, question_en: "When did Nova ask about?", answer: ["Yesterday and last night", "Yesterday, last night, and last week", "Last night and last week"], clue_statement: "Nova ask about yesterday, last night, and last week.", hint_en: "She asked about time words...", hint_vi: "Cô ấy hỏi về các từ chỉ thời gian..." }
  ]
};
