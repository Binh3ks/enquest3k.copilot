...
import daily_watch from '../../weeks/week_11/daily_watch.js';
import word_match from './word_match.js';
import { week11GamesEasy as games } from './games.js';

const weekData = {
  weekId: 11,
  isEasy: true,
  weekTitle_en: "Weekend Fun Spots (Easy)",
  weekTitle_vi: "Các Địa Điểm Vui Chơi Cuối Tuần (Dễ)",
