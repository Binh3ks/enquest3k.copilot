...
export default {
  ...
  content_vi: "Thứ Bảy tuần trước, Luna đi chợ với mẹ. Chợ đầy màu sắc và vui vẻ.\n\nLuna nhìn quanh và thấy nhiều gian hàng. Ở gian thủ công, cô thấy những lọ thủy tinh nhẵn bóng đựng đầy mật ong vàng.Ánh sáng chiếu qua thủy tinh tạo ra những cầu vồng nhỏ!\n\nLuna nhặt một cái kệ gỗ. Gỗ cảm thấy thô ráp và ấm áp dưới ngón tay cô. Cô cũng chạm vào một cái bát đá. Đá cảm thấy mát và nhẵn bóng.\n\nRồi Luna sờ những chiếc khăn cotton mềm mại. Chúng rất nhẹ và dịu dàng. Cô chạm cổng kim loại lạnh ở lối vào.\n\nLuna ngửi thấy dâu ngọt từ gian hàng trái cây. Cô nếm một miếng nhỏ xoài. Nó ngọt và thơm.\n\nMột túi nhựa bị rách gần cổng với tiếng động lớn! Luna giật mình. Rồi cô cười.\n\n'Chợ đầy những thứ để nhìn và cảm nhận!' Luna nói.",
  comprehension_questions: [
    {
      id: 1,
      question_en: "Who did Luna go to the market with?",
      answer: ["Her mum", "Her mother", "Luna went with her mum"],
      clue_statement: "Luna went to the market with her mum.",
      hint_en: "Luna went with her ___.",
      hint_vi: "Luna đi chợ cùng ___.",
      audio_url: "/audio/week31/read_q1_easy.mp3"
    },
    {
      id: 2,
      question_en: "How did the wooden shelf feel when Luna touched it?",
      answer: ["Rough and warm", "It felt rough and warm", "The wood felt rough and warm"],
      clue_statement: "The wood felt rough and warm under her fingers.",
      hint_en: "It felt ___ and ___ under her fingers.",
      hint_vi: "Nó cảm thấy ___ và ___ dưới ngón tay.",
      audio_url: "/audio/week31/read_q2_easy.mp3"
    },
    {
      id: 3,
      question_en: "What happened near the gate at the end of the visit?",
      answer: ["A plastic bag broke with a big crash", "A plastic bag broke", "The plastic bag broke"],
      clue_statement: "A plastic bag broke near the gate with a big crash!",
      hint_en: "A ___ ___ ___ with a big crash!",
      hint_vi: "Một ___ ___ ___ với tiếng động lớn!",
      audio_url: "/audio/week31/read_q3_easy.mp3"
    }
  ]
};
