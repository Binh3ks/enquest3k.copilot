const mindMapContent = {
  centerStems: [
    { text: "Luna went to the ___.", audio: "/audio/week31_easy/mindmap_stem_6zwfvf.mp3" },
  ...
  branchLabels: {
    "Luna went to the ___.": [
      { text: "market", audio: "/audio/week31_easy/mindmap_branch_quxp7e.mp3" },
    ...
    "She touched ___.": [
      { text: "the wood and it felt rough and warm", audio: "/audio/week31_easy/mindmap_branch_o2t9oa.mp3" },
      { text: "the stone and it felt cold and heavy", audio: "/audio/week31_easy/mindmap_branch_u84wtf.mp3" },
      { text: "the cotton and it felt soft and light", audio: "/audio/week31_easy/mindmap_branch_dq2ia2.mp3" },
      { text: "the metal and it felt cold and hard", audio: "/audio/week31_easy/mindmap_branch_mwtgth.mp3" },
      { text: "the glass and it felt smooth and cool", audio: "/audio/week31_easy/mindmap_branch_xpr56k.mp3" },
      { text: "the plastic and it felt light and smooth", audio: "/audio/week31_easy/mindmap_branch_f4ny1r.mp3" }
    ],
    "At home, I have ___.": [
      { text: "a chair made of wood", audio: "/audio/week31_easy/mindmap_branch_l4ss60.mp3" },
      { text: "a bowl made of stone", audio: "/audio/week31_easy/mindmap_branch_b72bzv.mp3" },
      { text: "a window made of glass", audio: "/audio/week31_easy/mindmap_branch_p5er40.mp3" },
      { text: "a bottle made of plastic", audio: "/audio/week31_easy/mindmap_branch_xp02uy.mp3" },
      { text: "a pot made of metal", audio: "/audio/week31_easy/mindmap_branch_n5ahv4.mp3" },
      { text: "a scarf made of cotton", audio: "/audio/week31_easy/mindmap_branch_o9zlai.mp3" }
    ],
    "When I touch ___.": [
      { text: "wood, it feels warm and rough", audio: "/audio/week31_easy/mindmap_branch_hk8scw.mp3" },
      { text: "stone, it feels cold and smooth", audio: "/audio/week31_easy/mindmap_branch_18k8s8.mp3" },
      { text: "cotton, it feels soft and light", audio: "/audio/week31_easy/mindmap_branch_1sppsk.mp3" },
      { text: "metal, it feels cold and hard", audio: "/audio/week31_easy/mindmap_branch_pjwj9l.mp3" },
