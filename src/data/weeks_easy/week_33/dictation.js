export default {
  title: "Dictation: Jake's Bad Day",
  ...
  sentences: [
    { id: 1, text: "Last Tuesday, Jake had an accident at school." },
    { id: 2, text: "He was running in the corridor because he was late." },
    { id: 3, text: "He ran too quickly and did not walk carefully." },
    { id: 4, text: "Suddenly, Jake hit his knee on a table." },
    { id: 5, text: "He fell down and broke a glass cup." },
    { id: 6, text: "The cup made a terrible noise!" },
    { id: 7, text: "Jake's knee hurt a lot." },
    { id: 8, text: "His friend ran to the nurse." },
    { id: 9, text: "The nurse came and put a cold pack on his knee." },
    { id: 10, text: "The teacher asked Jake to explain." },
    { id: 11, text: "Jake told the truth." },
    { id: 12, text: "He said he was running because he was late." },
    { id: 13, text: "The teacher said it was an important lesson." },
    { id: 14, text: "Everyone must walk carefully in the corridor." },
    { id: 15, text: "Jake understood." }
  ]
};
