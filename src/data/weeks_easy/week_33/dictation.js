export default {
  sentences: [
    ...
    { id: 4, text: "He **fell down hard** and **broke a glass cup**.", meaning: "Cậu ngã xuống và làm vỡ một chiếc cốc thủy tinh." },
    { id: 5, text: "His books **fell on the floor** and his pencil case opened.", meaning: "Sách của cậu rơi xuống sàn và hộp bút bị mở ra." },
    { id: 6, text: "The nurse **came quickly** and **put a cold pack** on his knee.", meaning: "Y tá đến và đặt túi chườm lạnh lên đầu gối của cậu." },
    { id: 7, text: "The teacher **asked Jake** what happened.", meaning: "Giáo viên hỏi Jake chuyện gì đã xảy ra." },
    { id: 8, text: "Jake **told the truth**.", meaning: "Jake nói sự thật." },
