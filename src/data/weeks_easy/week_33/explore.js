...
export default {
  ...
  check_questions: [
    {
      ...
      answer: ["He was late for class", "Jake was late"],
      audio_url: "/audio/week33/explore_q1.mp3"
    },
    {
      id: 2,
      question_en: "What did Jake break when he fell?",
      answer: ["A glass cup", "He broke a cup"],
      audio_url: "/audio/week33/explore_q2.mp3"
    },
    {
      id: 3,
      question_en: "What lesson did Jake learn?",
      answer: ["Always walk carefully", "Be careful in corridors"],
      audio_url: "/audio/week33/explore_q3.mp3"
    },
    {
      id: 4,
      question_en: "How did Jake's knee feel after the fall?",
      answer: ["It hurt a lot", "His knee hurt"],
      audio_url: "/audio/week33/explore_q4.mp3"
    }
  ],
  vocab_highlights: [
    { word: "corridor", meaning: "hành lang" },
    { word: "carefully", meaning: "cẩn thận" },
    { word: "terrible", meaning: "kinh khủng" },
  ...
  question: {
    text_en: "Tell me about Jake's accident! What happened? What lesson did he learn?",
    text_vi: "Kể cho cô nghe về tai nạn của Jake! Chuyện gì đã xảy ra?",
    min_words: 15,
    hint_en: "Jake was running... He hit... He learned...",
    hint_vi: "Jake đang chạy... Cậu đập... Cậu học được..."
  }
};
