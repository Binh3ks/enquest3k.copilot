// Week 3 (PRE-A1, EASY) — Lesson script now matches the video transcript
// segments for videoId zT5IiE9m9oY ("What does she look like"). Pre-fix the
// lesson was an unrelated mirror-description ("I look in the mirror...")
...
// correctly in both modes (lesson + transcript). Chunks (**bold**) follow
// the chunk-first ESL convention from CLAUDE.md.
export default {
  title: "Looking for Rora",
  videoId: "zT5IiE9m9oY",
  content_en: "What does she **look like**? Rora? I **don't know**. Oh, **no**. Excuse me. I'm **looking for** my little sister. Don't worry. What's her name? Rora. She's **six years old**. She has **short curly hair**. What is she wearing? She's wearing **a pink shirt and blue pants**. And she is wearing a **white cap**.",
  script: [
