...
export const dictionary = {
    'Fable lesson': { word: 'Fable lesson', pronunciation: '/fable lesson/', definition_vi: 'truyện ngụ ngôn bài học', definition_en: 'Key collocation: fable lesson', example: 'Natural usage of \'fable lesson\' in sentence context.' },
    ...
    'nothing to eat': { word: 'nothing to eat', pronunciation: '/nothing to eat/', definition_vi: 'nothing to ăn', definition_en: 'English phrase: nothing to eat', example: 'The phrase \'nothing to eat\' means nothing to ăn.' },
    'nowhere to go': { word: 'nowhere to go', pronunciation: '/nowhere to go/', definition_vi: 'nowhere to đi', definition_en: 'English phrase: nowhere to go', example: 'The phrase \'nowhere to go\' means nowhere to đi.' },
    ...
    'teaches a lesson': { word: 'teaches a lesson', pronunciation: '/teaches a lesson/', definition_vi: 'teaches một bài học', definition_en: 'Key collocation: teaches a lesson', example: 'Natural usage of \'teaches a lesson\' in sentence context.' },
