...
export const dictionary = {
    ...
    'for the rest of the year': { word: 'for the rest of the year', pronunciation: '/for the rest of the year/', definition_vi: '(cụm từ: for the rest of the year)', definition_en: 'Multi-word phrase: for the rest of the year', example: 'Use of \'for the rest of the year\' in natural context.' },
    ...
    'luôn chơi trò chơi': { word: 'luôn chơi trò chơi', pronunciation: '/luôn chơi trò chơi/', definition_vi: 'luôn chơi trò chơi', definition_en: 'key phrase: luôn chơi trò chơi', example: 'They used the phrase \'luôn chơi trò chơi\' in their reading.' },
    ...
    'làm việc chăm chỉ cùng nhau': { word: 'làm việc chăm chỉ cùng nhau', pronunciation: '/làm việc chăm chỉ cùng nhau/', definition_vi: 'làm việc chăm chỉ cùng nhau', definition_en: 'key phrase: làm việc chăm chỉ cùng nhau', example: 'They used the phrase \'làm việc chăm chỉ cùng nhau\' in their reading.' },
    ...
    'sự chăm chỉ luôn được đền bù cuối cùng': { word: 'sự chăm chỉ luôn được đền bù cuối cùng', pronunciation: '/sự chăm chỉ luôn được đền bù cuối cùng/', definition_vi: 'sự chăm chỉ luôn được đền bù cuối cùng', definition_en: 'key phrase: sự chăm chỉ luôn được đền bù cuối cùng', example: 'They used the phrase \'sự chăm chỉ luôn được đền bù cuối cùng\' in their reading.' },
    'there was': { word: 'there was', pronunciation: '/there was/', definition_vi: 'có (nghĩa tồn tại)', definition_en: 'meaning of there was', example: 'There was a big market near the river.' },
    'tiếp tục chơi': { word: 'tiếp tục chơi', pronunciation: '/tiếp tục chơi/', definition_vi: 'tiếp tục chơi', definition_en: 'key phrase: tiếp tục chơi', example: 'They used the phrase \'tiếp tục chơi\' in their reading.' },
    'vui vẻ khỏe mạnh suốt phần còn lại của năm': { word: 'vui vẻ khỏe mạnh suốt phần còn lại của năm', pronunciation: '/vui vẻ khỏe mạnh suốt phần còn lại của năm/', definition_vi: 'vui vẻ khỏe mạnh suốt phần còn lại của năm', definition_en: 'key phrase: vui vẻ khỏe mạnh suốt phần còn lại của năm', example: 'They used the phrase \'vui vẻ khỏe mạnh suốt phần còn lại của năm\' in their reading.' },
    ...
    'ánh nắng ấm đẹp': { word: 'ánh nắng ấm đẹp', pronunciation: '/ánh nắng ấm đẹp/', definition_vi: 'ánh nắng ấm đẹp', definition_en: 'key phrase: ánh nắng ấm đẹp', example: 'They used the phrase \'ánh nắng ấm đẹp\' in their reading.' },
