...
export default {
  ...
  content_en: `**A very long time ago**, there was **a hard-working ant** who lived in a small hill. There was also **a lazy grasshopper** who lived under a big green leaf. The ant was **always busy** while the grasshopper was **always playing games**.
...
**Day after day**, the ant **worked very hard all summer long**. She **carried heavy seeds** and **built a warm shelter** in the hill. The grasshopper just **kept playing** and **danced happily** in the **beautiful warm sunshine**. He **kept laughing** and **kept singing** all summer long.

Then **one cold day in autumn**, the first frost appeared. The grasshopper **felt very cold and very hungry**. He **came to the ant's house** and **asked for food**. The ant **gave the grasshopper some food** and invited him inside, saying he should **work with me next summer**.

**All winter long**, the two animals **shared food together**. The grasshopper **learned an important lesson**: **always work hard** and **prepare for the future**. The ant **smiled and agreed**. **From that day on**, both the ant and the grasshopper **worked hard together** and stayed **happy and healthy for the rest of the year**. The fable teaches us that **hard work always pays off in the end**.`,
