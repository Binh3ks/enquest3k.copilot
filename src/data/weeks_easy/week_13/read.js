...
export const dictionary = {
    'Good night': { word: 'Good night', pronunciation: '/good night/', definition_vi: 'tốt night', definition_en: 'Key collocation: good night', example: 'Natural usage of \'good night\' in sentence context.' },
    ...
    'come home': { word: 'come home', pronunciation: '/come home/', definition_vi: 'về nhà', definition_en: 'English phrase: come home', example: 'The phrase \'come home\' means về nhà.' },
    ...
    'my day': { word: 'my day', pronunciation: '/my day/', definition_vi: 'my ngày', definition_en: 'English phrase: my day', example: 'The phrase \'my day\' means my ngày.' },
    'my name': { word: 'my name', pronunciation: '/my name/', definition_vi: 'cụm từ vựng: my name', definition_en: 'Collocation: my name', example: 'The students learned \'my name\' in their English lesson.' },
