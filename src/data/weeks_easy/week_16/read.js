export default {
  ...
  content_en: "Today is my first soccer game! I am very excited. Look! I **am running fast**. My legs are moving. This is fun! My friend **is kicking the** ball. I **am catching** it. Now I **am passing** it. The ball **has energy**. It **is in** motion. The ball **is moving**! Our team **is playing**. Everyone **is cheering**. \"Go, go!\" they shout. Oh no! I **throw the** ball. That is wrong! I **can only use** my feet. The other team **is scoring** a goal. They **are jumping** up. They are happy. I **want to score** a goal too! I love soccer!",
