export default {
  ...
  "vocabulary_bank": {
    ...
    "words": [
      ...
      {
        "word": "running very fast",
        "vi": "chay rat nhanh",
        "distractor": false
      },
      {
        "word": "kicking the ball",
        "vi": "sut bong",
        "distractor": false
      },
      {
  ...
  "story_prompts": {
    "picture_mode": {
      ...
      "sentence_frames": [
        {
          "template": "At the track, ___",
          "answers": [
            "students are running"
          ]
        },
        {
          "template": "On the field, ___",
          "answers": [
            "the game is exciting"
          ]
        },
        {
          "template": "Meanwhile, ___",
          "answers": [
            "the crowd is cheering"
          ]
        },
        {
          "template": "The jumper is ___",
          "answers": [
            "jumping very high"
          ]
        },
        {
          "template": "After the race, ___",
          "answers": [
            "everyone celebrates"
          ]
        },
