export default {
  ...
  "sentence_frames": [
    {
      "template": "Last Saturday, I woke up ___ and made my bed.",
      "answers": [
        "early"
      ]
    },
    {
      "template": "First, I kept my room ___ by cleaning.",
      "answers": [
        "tidy"
      ]
    },
    {
      "template": "Then I wrote ___ to my grandmother.",
      "answers": [
        "a letter"
      ]
    },
    {
      "template": "I helped ___ cut the grass.",
      "answers": [
        "Dad"
      ]
    },
    ...
    {
      "template": "I chose ___ at the café.",
      "answers": [
        "a muffin"
      ]
    },
    {
      "template": "I paid for ___ with my own money.",
      "answers": [
        "it"
      ]
    },
    {
      "template": "At night, I put ___ away and fell asleep early.",
      "answers": [
        "my things"
      ]
    },
  ...
  "story_prompts": {
    "picture_mode": {
      ...
      "sentence_frames": [
        {
          "template": "Last Saturday, I woke up ___",
          "answers": [
            "early"
          ]
        },
        {
          "template": "First, I ___",
          "answers": [
            "tidied my room"
          ]
        },
        {
          "template": "Then I wrote a ___",
          "answers": [
            "letter"
          ]
        },
        ...
        {
          "template": "At the café, I chose ___",
          "answers": [
            "a muffin"
          ]
        },
        {
          "template": "By evening I felt ___",
          "answers": [
            "tired but happy"
          ]
        },
