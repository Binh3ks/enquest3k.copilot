export default {
  ...
  content_en: "Alex loves the news. Today he has a **toy microphone** and a **toy camera**. He wants to be a reporter! He stands **in the living room**. He says: \"Good morning! This is **live news from** my home!\" He begins to **describe the scene**. He says: \"**My mom** is **making breakfast**. My **little brother** is **playing with his toy**. My cat is **sleeping on the sofa**. What a busy scene!\" He turns to his cat. He **holds out the microphone**. He says: \"I will now interview the cat!\" The cat **looks up**. Alex laughs. He says: \"The cat has no report today!\" His mom and brother **clap loudly**. They are **his audience**. Alex **bows happily**. **It is so exciting** to be a reporter! He loves describing **what is happening** **at home**.",
  content_vi: "Alex rất thích xem tin tức. Hôm nay cậu có một cái micro đồ chơi và một cái máy quay đồ chơi. Cậu muốn trở thành phóng viên! Cậu đứng trong phòng khách. Cậu nói: \"Chào buổi sáng! Đây là tin tức trực tiếp từ nhà tôi!\" Cậu bắt đầu mô tả khung cảnh. Cậu nói: \"Mẹ tôi đang làm bữa sáng. Em trai tôi đang chơi với đồ chơi của mình. Mèo của tôi đang ngủ trên ghế sofa. Thật là một khung cảnh sôi động!\" Cậu quay sang con mèo. Cậu giơ micro ra. Cậu nói: \"Bây giờ tôi sẽ phỏng vấn con mèo!\" Con mèo ngước nhìn. Alex bật cười. Cậu nói: \"Con mèo không có bản tin nào hôm nay!\" Mẹ và em trai cậu vỗ tay. Họ là khán giả. Alex cúi chào. Thật hào hứng khi được làm phóng viên! Cậu thích mô tả những gì đang xảy ra ở nhà.",
  comprehension_questions: [
    { id: 1, question_en: "What does Alex use to be a reporter?", answer: ["A toy microphone and a toy camera", "Microphone and camera", "A toy microphone and camera"], clue_statement: "He uses a toy microphone and a toy camera.", hint_en: "He has two toys...", hint_vi: "Cậu có hai đồ chơi..." },
    { id: 2, question_en: "Who is the audience for Alex's news show?", answer: ["His mom and brother", "Mom and little brother", "His mom and little brother"], clue_statement: "His mom and brother are the audience.", hint_en: "They clap for Alex...", hint_vi: "Họ vỗ tay cho Alex..." },
    { id: 3, question_en: "What is the cat doing?", answer: ["Sleeping on the sofa", "The cat is sleeping", "It is sleeping on the sofa"], clue_statement: "The cat is sleeping on the sofa.", hint_en: "The cat is on the sofa...", hint_vi: "Con mèo đang ở trên ghế sofa..." },
    { id: 4, question_en: "What does Alex love?", answer: ["news", "the news"], clue_statement: "Alex loves the news.", hint_en: "Think about what Alex loves...", hint_vi: "Nghĩ về Alex..." },
...
export const dictionary = {
    ...
    'holds out the microphone': { word: 'holds out the microphone', pronunciation: '/holds out the microphone/', definition_vi: 'cầm / giữ ra the micrô', definition_en: 'Collocation: holds out the microphone', example: 'The students learned \'holds out the microphone\' in their English lesson.' },
    ...
    'looks up': { word: 'looks up', pronunciation: '/looks up/', definition_vi: 'looks lên', definition_en: 'Key collocation: looks up', example: 'Natural usage of \'looks up\' in sentence context.' },
