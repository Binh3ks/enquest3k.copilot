export default {
  ...
  script: [
    ...
    { id: 3, text: "My house has many rooms.", vi: "Ngôi nhà của tôi có nhiều phòng." },
    { id: 4, text: "I sleep in my bedroom.", vi: "Tôi ngủ trong phòng ngủ của tôi." },
    { id: 5, text: "I have a soft bed in my bedroom.", vi: "Tôi có một cái giường mềm trong phòng ngủ." },
    { id: 6, text: "I eat breakfast in the kitchen.", vi: "Tôi ăn sáng trong bếp." },
    { id: 7, text: "I sit on a chair at the table for dinner.", vi: "Tôi ngồi trên ghế ở bàn để ăn tối." },
