export default {
  ...
  sentence_frames: [{"template":"Last ___, my family went to ___."},{"template":"We went by ___. It took ___ hours."},{"template":"When we arrived, I saw ___ and ___."},{"template":"We ___ed ___ and ___ together."},{"template":"The most exciting thing was ___."},{"template":"My favourite memory was ___ because ___."}],
  hints: {
    vocabulary_bank: {
      label_en: "💡 Word Bank",
