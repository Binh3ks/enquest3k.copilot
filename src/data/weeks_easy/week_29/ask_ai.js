export default {
  ...
  prompts: [
    {
      id: 1,
      context_en: "The plane flew very fast and went up into the sky. Ask Ms. Nova how planes fly.",
    ...
    {
      id: 2,
      context_en: "The family went to the airport and flew to Da Nang. Ask Ms. Nova what Da Nang is famous for.",
    ...
    {
      id: 3,
      context_en: "In the story, 'go' becomes 'went' in the past. Ask Ms. Nova why.",
    ...
    {
      id: 4,
      context_en: "At the airport, there was luggage, tickets, and a departure gate. Ask Ms. Nova what a departure gate is.",
