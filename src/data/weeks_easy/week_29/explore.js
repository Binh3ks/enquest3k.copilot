export default {
  ...
  content_en: "Lily met many people with amazing jobs on her magic trip!\n\nA **pilot** flies aeroplanes. The **pilot** takes passengers safely from one place to another. On the ground, a **driver** drives buses, taxis, and trucks. A **driver** helps people travel every day.\n\nA **farmer** grows food for us. The **farmer** works on a farm and grows vegetables, fruit, and rice. We eat food every day because of **farmers**!\n\nA **teacher** helps children learn. The **teacher** explains new things and answers questions. Learning is a great adventure!\n\nAt the hospital, a **doctor** helps sick people get better. A **nurse** works with the doctor and looks after patients every day.\n\nAll these jobs are very important. Which job do you like best?",
