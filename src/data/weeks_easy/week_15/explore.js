export default {
  ...
  image_url: "/images/week15_easy/explore_cover_w15.jpg",
  audio_url: "/audio/week15_easy/explore_main.mp3",
  content_en: "I love going to the park! The park near my house is my favorite place. Every weekend, my family is going there together. What are we doing at the park? My dad is jogging around the big path. He is wearing his red sports shirt. I can see him running! My mom is sitting on a bench. She is reading her book and relaxing. Sometimes she is watching me play. I am running and playing with my friends. We are laughing and having so much fun! My little brother is flying his yellow kite. The kite is going very high in the sky. He is so happy! Near the fountain, other kids are playing too. They are splashing water and running around. Some families are having picnics on the grass. They are eating yummy food together. An old man is walking his dog. The dog is cute and friendly. I want to pet it! I am relaxing under a big tree now. The tree gives me nice shade. The park is so fun and beautiful. I go there every week!",
