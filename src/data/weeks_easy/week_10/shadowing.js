export default {
  ...
  script: [
    ...
    { id: 4, text: "I see a big brown cow.", vi: "Tôi thấy một con bò nâu lớn." },
    { id: 5, text: "The animal eats grass in the field.", vi: "Con bò ăn cỏ trên đồng." },
    { id: 6, text: "I see a small white chicken.", vi: "Tôi thấy một con gà trắng nhỏ." },
    { id: 7, text: "The bird runs fast.", vi: "Con gà chạy nhanh." },
    { id: 8, text: "The farm is clean.", vi: "Trang trại sạch sẽ." },
    { id: 9, text: "The field is green.", vi: "Cánh đồng xanh." },
    { id: 10, text: "I see tall trees.", vi: "Tôi thấy cây cao." },
    { id: 11, text: "The countryside is peaceful.", vi: "Vùng nông thôn yên bình." },
