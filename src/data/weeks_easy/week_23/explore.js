export default {
  title_en: "Colors in Art: Mixing Pigments and Finding Symmetry",
...
Sau do dung **scissors** de **cut** hinh. Them **color**, roi **glue** len mot to giay khac. Tac pham nghe thuat cua ban da san sang!`,
  check_questions: [
    {
      id: 1,
      question_en: "What do you get when you mix red and blue pigment?",
      question_vi: "Ban duoc gi khi tron pigment do va xanh lam?",
      answer: ["Purple", "You get purple", "Purple color"],
      hint_en: "Red + blue = ...",
      hint_vi: "Do + xanh lam = ...",
      audio_url: "/audio/week23_easy/explore_q1.mp3"
    },
    {
      id: 2,
      question_en: "How can you create symmetry in your art?",
      question_vi: "Lam the nao ban co the tao ra tinh doi xung trong nghe thuat?",
      answer: ["Paint on one side then fold the paper", "By painting and folding", "Fold the paper after painting"],
      hint_en: "Paint on one side then...",
      hint_vi: "Ve mot ben roi...",
      audio_url: "/audio/week23_easy/explore_q2.mp3"
    },
    {
      id: 3,
  ...
  question: {
    text_en: "Describe what you painted or created in art class. Use past tense verbs like painted, colored, folded, cut, or glued.",
    text_vi: "Mo ta nhung gi ban da ve hoac tao ra trong lop my thuat. Dung dong tu qua khu nhu painted, colored, folded, cut, hoac glued.",
    min_words: 20,
    hint_en: "Yesterday I painted... I also folded and cut... I glued...",
    hint_vi: "Hom qua toi da ve... Toi cung gap va cat... Toi da dan..."
  }
};
