const mindMapContent = {
  centerStems: [
    { text: "I ___ in art class.", audio: "/audio/week23_easy/mindmap_stem_9paprq.mp3" },
    { text: "I used ___.", audio: "/audio/week23_easy/mindmap_stem_2fja4l.mp3" },
    { text: "My picture had ___.", audio: "/audio/week23_easy/mindmap_stem_xd15tm.mp3" },
    { text: "I ___ the paper.", audio: "/audio/week23_easy/mindmap_stem_pkr51z.mp3" },
    { text: "Yesterday I ___.", audio: "/audio/week23_easy/mindmap_stem_v7berg.mp3" },
    { text: "I created ___.", audio: "/audio/week23_easy/mindmap_stem_n5x9ky.mp3" }
  ],
  branchLabels: {
    "I ___ in art class.": [
      ...
      { text: "used a brush", audio: "/audio/week23_easy/mindmap_branch_6gro2r.mp3" }
    ],
    "I used ___.": [
      { text: "a brush to paint", audio: "/audio/week23_easy/mindmap_branch_so1ghw.mp3" },
    ...
    "My picture had ___.": [
      ...
      { text: "nice texture", audio: "/audio/week23_easy/mindmap_branch_m2ydx1.mp3" },
      { text: "good symmetry", audio: "/audio/week23_easy/mindmap_branch_ge9idi.mp3" }
    ],
    "I ___ the paper.": [
    ...
    "Yesterday I ___.": [
      ...
      { text: "created a picture", audio: "/audio/week23_easy/mindmap_branch_k5a1fo.mp3" }
    ],
    "I created ___.": [
      { text: "a picture using paint", audio: "/audio/week23_easy/mindmap_branch_9w97vo.mp3" },
      { text: "a butterfly using paper", audio: "/audio/week23_easy/mindmap_branch_ykrmg7.mp3" },
      { text: "a border using leaves", audio: "/audio/week23_easy/mindmap_branch_q71974.mp3" },
      { text: "a picture using scissors and glue", audio: "/audio/week23_easy/mindmap_branch_4dv5hv.mp3" },
      { text: "a flower using a brush", audio: "/audio/week23_easy/mindmap_branch_qv33ye.mp3" },
      { text: "a design using fold and cut", audio: "/audio/week23_easy/mindmap_branch_bj2h9g.mp3" }
    ]
  }
};
