export default {
  ...
  script: [
    ...
    { id: 3, text: "My father is strong and plays with me in the park.", vi: "Bố tôi mạnh mẽ và chơi với tôi ở công viên." },
    { id: 4, text: "My brother helps me with my homework.", vi: "Anh trai tôi giúp tôi làm bài tập." },
    { id: 5, text: "My sister is funny and draws pictures for me.", vi: "Em gái tôi vui tính và vẽ tranh cho tôi." },
