...
export const dictionary = {
    ...
    'play games': { word: 'play games', pronunciation: '/play games/', definition_vi: 'chơi games', definition_en: 'English phrase: play games', example: 'The phrase \'play games\' means chơi games.' },
