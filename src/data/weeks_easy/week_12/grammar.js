export default {
  grammar_explanation: {
    ...
    rules: [
      { type: "rule", icon: "1️⃣", rule_en: "Use 'I can' to talk about abilities: I can swim.", example_en: "I can swim. I can sing. She can draw.", example_vi: "Tôi có thể bơi. Tôi có thể hát. Cô ấy có thể vẽ.", rule_vi: "Dùng 'I can' để nói về khả năng: Tôi có thể bơi." },
      { type: "rule", icon: "2️⃣", rule_en: "Use 'I can't' (cannot) for things you cannot do: I can't fly.", example_en: "I can't fly. I can't run fast. He can't cook.", example_vi: "Tôi không thể bay. Tôi không thể chạy nhanh. Anh ấy không thể nấu ăn.", rule_vi: "Dùng 'I can't' cho việc không thể làm: Tôi không thể bay." },
      { type: "rule", icon: "3️⃣", rule_en: "Use 'Can you...?' to ask about abilities: Can you dance?", example_en: "Can you dance? Can you sing? Can he jump?", example_vi: "Bạn có thể nhảy không? Bạn có thể hát không? Anh ấy có thể nhảy không?", rule_vi: "Dùng 'Can you...?' để hỏi về khả năng: Bạn có thể nhảy không?" },
      { type: "rule", icon: "4️⃣", rule_en: "After 'can', always use base verb (not -ing or -s): He can run.", example_en: "He can run (✓). He can runs (✗). I can dancing (✗).", example_vi: "He can run (✓). He can runs (✗). I can dancing (✗).", rule_vi: "Sau 'can', luôn dùng động từ gốc: Anh ấy có thể chạy." }
    ]
  },
  exercises: [
