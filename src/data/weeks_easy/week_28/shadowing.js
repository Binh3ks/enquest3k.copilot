export default {
  ...
  sentences: [
    { id: 1, text: "Once upon a time, a hare was very proud and fast." },
    { id: 2, text: "He always bragged about winning every race and looked at the slow tortoise with laughter." },
    { id: 3, text: "One day, the tortoise smiled and said, 'Slow and steady wins the race." },
    { id: 4, text: "The hare got on his bicycle while the tortoise got on his boat." },
    { id: 5, text: "BANG — the race began." },
    { id: 6, text: "The hare got ahead of everyone but then he got tired and fell asleep under a big shady tree." },
    { id: 7, text: "Meanwhile, the tortoise kept on sailing slowly but never stopped and never gave up." },
    { id: 8, text: "He crossed the river and kept going to the finish line." },
    { id: 9, text: "All the forest animals watched from the riverbank." },
    { id: 10, text: "They could not believe the tortoise was winning the race." },
    { id: 11, text: "When the hare woke up, the tortoise was already there." },
    { id: 12, text: "The tortoise won the race." },
    { id: 13, text: "All the animals cheered loudly." },
    { id: 14, text: "Slow and steady wins the race." }
  ]
};
