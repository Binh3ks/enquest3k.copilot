export default {
  ...
  check_questions: [
    {
      id: 1,
      question_en: "What vehicle is very popular in Vietnam?",
      answer: ["Motorbike", "The motorbike", "A motorbike"],
      hint_en: "In Vietnam, lots of people ride a ___ every day.",
      hint_vi: "Ở Việt Nam, nhiều người đi ___ mỗi ngày.",
      audio_url: "/audio/week28_easy/explore_q1.mp3"
    },
    {
      id: 2,
      question_en: "What is the difference between a boat and a ship?",
      answer: ["A boat is small and good for rivers, a ship is very big and travels across the sea", "A boat is small, a ship is very big", "Boats are small, ships are big and go across the sea"],
      hint_en: "A ___ is small and good for rivers. A ___ is very big and travels across the sea.",
      hint_vi: "Thuyền ___ và tốt cho sông. Tàu biển ___ và đi qua biển.",
      audio_url: "/audio/week28_easy/explore_q2.mp3"
    },
    {
      id: 3,
      question_en: "Why is a bicycle good for your health?",
      answer: ["Because it uses your legs, not fuel", "You use your legs, not a motor", "It uses no fuel and exercises your legs"],
      hint_en: "A bicycle is healthy because it uses your ___, not fuel.",
