export default {
  ...
  prompts: [
    {
      id: 1,
      context_en: "The tortoise won the race but he was very slow. Ask Ms. Nova why.",
    ...
    {
      id: 2,
      context_en: "The hare ran very fast at the start but he stopped to sleep. Ask Ms. Nova why the hare slept.",
    ...
    {
      id: 3,
      context_en: "You see the word 'ran' in the story. Ask Ms. Nova what verb it comes from.",
    ...
    {
      id: 4,
      context_en: "Ms. Nova said 'sleep' becomes 'slept' in the past. Ask Ms. Nova for another example like this.",
    ...
    {
      id: 5,
      context_en: "Your teacher said this story is a fable. Ask Ms. Nova what a fable is.",
