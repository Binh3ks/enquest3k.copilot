...
export const chunk_focus = [
  ...
  "Without hesitation",
  "decided to clean up",
  "entire park together",
  "First",
  "put on gloves",
  "collected all the plastic waste",
  "recycling bins",
  "Next",
...
export const dictionary = {
  ...
  "Không một chút do dự": "Without hesitation",
  "quyết định cùng nhau dọn dẹp": "decided to clean up",
  "toàn bộ công viên": "entire park together",
  "Đầu tiên": "First",
  "đeo găng tay": "put on gloves",
  "gom toàn bộ rác thải nhựa": "collected all the plastic waste",
