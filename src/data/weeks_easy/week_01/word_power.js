  ...
  words: [
    {
      ...
      definition_en: "Người bạn của tôi.", definition_vi: "Người bạn của tôi.",
      example: "This is my friend.",
      model_sentence: "My friend is nice and kind.",
      collocation: "my friend / my good friend / my best friend",
    ...
    },
    {
      ...
      definition_en: "Trên bàn.", definition_vi: "Trên bàn.",
      example: "My pen is on the desk.",
      model_sentence: "Put your bag on the desk.",
      collocation: "on the desk / on my desk / put on the desk",
    ...
    },
    {
      ...
      definition_en: "Trong hộp.", definition_vi: "Trong hộp.",
      example: "The toy is in the box.",
      model_sentence: "Put your pen in the box.",
      collocation: "in the box / in my bag / put in the box",
