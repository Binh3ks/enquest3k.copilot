...
In the park, an artist was painting by the lake. Luna gave a cookie to the artist and he **waved back** with a big smile. They **spread out** the **soft blanket** on the green grass. The children **ate the food** and **drank lemonade**. 'Don't eat too many cookies!' laughed Mia. Everyone **felt cheerful**.`,
  ...
  sentences: [
    { id: 1, text: "Last Sunday, the children had a picnic in the park." },
    { id: 2, text: "Tom's dad is a good cook and made cheese sandwiches, cookies, and cold lemonade." },
    { id: 3, text: "He put everything in a big picnic basket and said, 'A good cook always prepares the best food!'" },
    { id: 4, text: "Mia's mum brought fresh strawberries and said, 'The more colourful, the healthier!'" },
    { id: 5, text: "Luna's dad is an engineer who designed the beautiful wooden bridge they crossed the river on." },
    { id: 6, text: "'I helped to build this bridge!' he said proudly." },
    { id: 7, text: "Near the park, firefighters were having lunch beside their big red fire truck." },
    { id: 8, text: "Tom waved at them and they waved back with big smiles." },
    { id: 9, text: "At the market, Luna's dad bought a big juicy watermelon." },
    { id: 10, text: "An artist was painting by the lake." },
    { id: 11, text: "They spread out the soft blanket on the green grass." },
    { id: 12, text: "The children ate the food and drank lemonade." }
  ]
};
