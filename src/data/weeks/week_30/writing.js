export default {
  ...
  sentence_frames: [
    {"template":"Last ___, my family had a picnic at the ___ ___."},
    {"template":"The weather was ___ and the place was very ___."},
  ...
  hints: {
    vocabulary_bank: {
      ...
      words: [
        ...
        {word: "shared", vi: "đã chia sẻ", distractor: false},
        ...
        {word: "cake", vi: "bánh", distractor: false},
