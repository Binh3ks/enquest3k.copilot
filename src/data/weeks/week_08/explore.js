...
export const dictionary = {
    ...
    'one thing': { word: 'one thing', pronunciation: '/one thing/', definition_vi: 'cụm từ vựng: one thing', definition_en: 'Collocation: one thing', example: 'The students learned \'one thing\' in their English lesson.' },
