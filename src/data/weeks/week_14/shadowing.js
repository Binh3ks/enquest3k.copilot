export default {
  ...
  script: [
    ...
    { id: 4, text: "This is my family.", vi: "Đây là gia đình tôi, và tôi yêu họ vì họ luôn ủng hộ tôi." },
    ...
    { id: 6, text: "Now I talk about my talents!", vi: "Bây giờ tôi nói về tài năng của mình, và tôi hy vọng bạn thích tìm hiểu về tôi!" },
    ...
    { id: 8, text: "I am good at drawing too.", vi: "Tôi cũng giỏi vẽ, vì vậy tôi đã vẽ những bức tranh đẹp về động vật và hoa." },
    { id: 9, text: "When I stand here, I feel very confident because the audience listens carefully.", vi: "Khi tôi đứng đây, tôi cảm thấy rất tự tin vì khán giả lắng nghe cẩn thận và mỉm cười với tôi." },
