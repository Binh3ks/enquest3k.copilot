export default {
  ...
  story_prompts: {
    picture_mode: {
      ...
      image_prompt: "A fantastic football match at school. Students are running, kicking, and scoring goals on a green field.",
      word_bank: ["very excited","coming to watch","bringing his camera","running very fast","kicking the ball","catching it with my foot","passing it to another friend","running to the goal","has energy","in motion","moving fast through the air","playing soccer together","working together","cheering loudly","shouting with excitement"],
      writing_prompts: {
