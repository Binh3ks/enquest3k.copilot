...
export const dictionary = {
    ...
    'having fun': { word: 'having fun', pronunciation: '/having fun/', definition_vi: 'having vui vẻ', definition_en: 'Key collocation: having fun', example: 'Natural usage of \'having fun\' in sentence context.' },
    ...
    'scores a goal': { word: 'scores a goal', pronunciation: '/scores a goal/', definition_vi: 'scores một goal', definition_en: 'Key collocation: scores a goal', example: 'Natural usage of \'scores a goal\' in sentence context.' },
    ...
    'uses energy': { word: 'uses energy', pronunciation: '/uses energy/', definition_vi: 'cụm từ vựng: uses energy', definition_en: 'Collocation: uses energy', example: 'The students learned \'uses energy\' in their English lesson.' },
    ...
    'working as a team': { word: 'working as a team', pronunciation: '/working as a team/', definition_vi: 'working as một team', definition_en: 'Key collocation: working as a team', example: 'Natural usage of \'working as a team\' in sentence context.' }
};
