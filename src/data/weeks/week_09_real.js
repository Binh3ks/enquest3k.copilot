const week9RealData = {
  ...
  nova_instructions: {
    ...
    opening_lines_by_mission: {
      mission_1: "Hi! I am Ms. Nova! I love walking in the city! Let's explore together. What do I call you? Say: My name is your name.",
  ...
  story_missions: [
    {
      ...
      story_character: {
        ...
        backstory: "Ms. Nova is a tour guide who shows visitors around the city!",
  ...
  conversation_cards: [
    {
      ...
      exchanges: [
        ...
        {
          ai: "Is the city noisy or quiet? Say: It is a ___",
        ...
        {
          ai: "Is the street busy or empty? Say: It is a ___ street",
          fill_blank: "It is a ___ street",
          accept_words: ["busy", "empty", "quiet", "noisy", "it is"]
        },
        {
          ai: "Describe the building! Say: It is a ___ building",
    ...
    },
    {
      ...
      exchanges: [
        ...
        {
          ai: "What color is the car? Say: It is a ___ car",
        ...
        {
          ai: "Describe the traffic! Say: The traffic is ___",
    ...
    },
    {
      ...
      exchanges: [
        ...
        {
          ai: "Do you want modern buildings or old buildings? Say: I want ___ buildings",
        ...
        {
          ai: "Do you want a noisy city or a quiet city? Say: I want a ___ city",
        ...
        {
          ai: "Your city is ready! Describe it! Say: It is a ___ city with ___ buildings",
