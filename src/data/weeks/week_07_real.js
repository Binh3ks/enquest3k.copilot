const week7RealData = {
  ...
  grammar_pattern: "There is a book in my the park",
  grammar_examples: [
  ...
  nova_instructions: {
    ...
    opening_lines_by_mission: {
      mission_1: "Hi! I am Nova! I love checking backpacks! Let's check your backpack together. What do I call you? Say: My name is your name.",
    ...
    conversation_style: [
      ...
      "ONLY use 'There is a/an book in my the park' - Week 7 grammar scope"
    ],
    ...
    vocabulary_scaffolding: [
      ...
      "Mission 3: combine all vocab in 'There is a/an book in my the park' guessing game"
    ],
    questioning_skill: [
  ...
  story_missions: [
    {
      ...
      story_character: {
        ...
        backstory: "Nova helps students check their backpacks before school starts!",
    ...
    },
    {
      ...
      opening_narrative: "Hi! I'm Nova! 🔍 Let's play Treasure Hunt in my classroom! I hide many things! (Point 👉 at whiteboard) Look! I found something at the front! What is this? Say: There is a...",
  ...
  spark_talk: [
    {
      id: 'spark_my_backpack',
      emoji: '🎒',
      title: 'My Backpack',
      bridge: 'We opened a magic backpack and found so many things inside — pen, ruler, eraser, book! 🎒',
      seed_question: 'What is in your backpack? Is there a book or a pencil case?',
      frames: [
        { template: 'There is a ___ in my backpack', follow_up_q: 'What is in your backpack? A book or a pencil?', hints: ['book', 'pencil case', 'water bottle'] },
        { template: 'There is a ___ in my bag', follow_up_q: 'What is in your bag today?', hints: ['notebook', 'ruler', 'eraser'] },
        { template: 'There is a ___ in my classroom', follow_up_q: 'What is in your classroom? A board or a desk?', hints: ['board', 'desk', 'big clock'] },
        { template: 'There is a ___ in my pencil case', follow_up_q: 'What is in your pencil case?', hints: ['pen', 'pencil', 'eraser'] },
        { template: 'There is a big ___ in my school', follow_up_q: 'What big thing is in your school?', hints: ['playground', 'library', 'garden'] },
        { template: 'There is a ___ in my school bag', follow_up_q: 'What else is in your school bag?', hints: ['lunch box', 'book', 'pencil case'] },
        { template: 'There is a ___ in my favourite bag', follow_up_q: 'What is special in your favourite bag?', hints: ['lucky eraser', 'small toy', 'shiny pencil'] },
        { template: 'There is a ___ in my bag', follow_up_q: 'What two things are in your bag?', hints: ['book and a ruler', 'ruler and an eraser', 'lunch box and a notebook'] }
      ],
      scaffold_frames: ['There is a ___ in my backpack', 'I have a ___', 'There is no ___'],
      vocab_focus: ['pen', 'pencil', 'ruler', 'eraser', 'book', 'notebook'],
      turns: 8
    },
    {
      id: 'spark_classroom_spy',
      emoji: '🔍',
      title: 'Classroom Spy',
      bridge: 'We played a pointing game in the classroom — a pen here, a ruler there! 👀',
      seed_question: 'What is in your classroom? Is there a big board or a clock?',
      frames: [
        { template: 'There is a ___ in my classroom', follow_up_q: 'What is in your classroom? A board or a clock?', hints: ['board', 'clock', 'big window'] },
        { template: 'There is a ___ on the wall', follow_up_q: 'What is on the classroom wall?', hints: ['picture', 'alphabet chart', 'clock'] },
        { template: 'There is a ___ on the teacher\'s desk', follow_up_q: 'What is on the teacher\'s desk?', hints: ['pen', 'book', 'a laptop'] },
        { template: 'There is a ___ near the door', follow_up_q: 'What is near the classroom door?', hints: ['bin', 'coat rack', 'small shelf'] },
        { template: 'There is a ___ in front of me', follow_up_q: 'What is in front of you in class?', hints: ['desk', 'whiteboard', 'another student'] },
        { template: 'There is a ___ behind me', follow_up_q: 'What is behind you in class?', hints: ['door', 'bookshelf', 'another desk'] },
        { template: 'There is a ___ in my favourite corner', follow_up_q: 'What is in your favourite corner of the classroom?', hints: ['reading area', 'plant', 'book corner'] },
        { template: 'There is a ___ in the classroom', follow_up_q: 'What two things are in your classroom?', hints: ['board and a clock', 'desk and a chair', 'window and a bookshelf'] }
      ],
      scaffold_frames: ['I can see a ___', 'There is a ___ on the ___', 'I have ___ ___s'],
      vocab_focus: ['pen', 'book', 'bag', 'chair', 'table'],
      turns: 8
    }
  ],
  ...
  conversation_cards: [
    {
      ...
      exchanges: [
        ...
        {
          ai: "What else is in your bag? Say: There is a pen! or There is a book! or There is a pencil!",
        ...
        {
          ai: "Remember: AN before vowels! Is there an eraser? Say: There is an eraser! or There is an apple! or There is an umbrella!",
          fill_blank: "There is an ___",
          accept_words: ["eraser", "an eraser", "umbrella", "apple"]
        },
        {
          ai: "Tell me one thing you have in your bag! Say: There is a pen! or There is a book! or There is a pencil!",
          fill_blank: "There is a ___",
    ...
    },
    {
      ...
      exchanges: [
        ...
        {
          ai: "AN before vowel sounds! Say: There is an eraser! or There is an apple! or There is an umbrella!",
          fill_blank: "There is an ___",
        ...
        {
          ai: "What colour is your pencil case? Say: My pencil case is red! or My pencil case is blue! or My pencil case is green!",
          fill_blank: "My pencil case is ___",
          accept_words: ["red", "blue", "green", "yellow", "pink", "black", "white", "purple", "pencil case"]
        },
        {
          ai: "Tell me TWO things in your pencil case! Say: There is a pen and there is an eraser! or There is a pencil and there is a ruler!",
    ...
    },
    {
      ...
      exchanges: [
        ...
        {
          ai: "Look around! What do you see? Say: There is a desk in my classroom! or There is a chair in my classroom! or There is a board in my classroom!",
        ...
        {
          ai: "What do you see in your classroom? Say: There is a board! or There is a desk! or There is a chair!",
          fill_blank: "There is a ___",
