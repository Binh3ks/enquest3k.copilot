const week8RealData = {
  ...
  nova_instructions: {
    ...
    opening_lines_by_mission: {
      mission_1: "Hi! I am Ms. Nova! Today we count EVERYTHING in our classroom! I love counting! Let's start! How many desks do you see? Say: There are... desks.",
  ...
  story_missions: [
    {
      ...
      story_character: {
        ...
        backstory: "Ms. Nova checks the classroom every Monday morning and counts everything!",
    ...
    },
    {
      ...
      story_character: {
        ...
        backstory: "Ms. Nova organizes the supply shelf every week! She needs help counting everything!",
      ...
      opening_narrative: "Hi! I'm Ms. Nova! Look at our supply shelf! There are SO MANY things! Help me count! How many pencils are there? Say: There are...",
    ...
    },
    {
      ...
      story_character: {
        ...
        backstory: "Ms. Nova thinks counting is more fun when it's a guessing game! She gives clues and students guess!",
      ...
      story_arc: [
        ...
        },
        {
          ...
          phase_questions: [
            ...
            "Great game! See you tomorrow! Goodbye! Say: Goodbye Ms. Nova!"
          ]
        }
      ],
  ...
  conversation_cards: [
    {
      ...
      exchanges: [
        ...
        {
          ai: "How many students are there? Say: There are ___ students",
        ...
        {
          ai: "Look at the bags! How many bags? Say: There are ___ bags",
          fill_blank: "There are ___ bags",
          accept_words: ["many", "bags", "30", "lots", "there are"]
        },
        {
          ai: "Count something in YOUR classroom! Say: There are ___",
    ...
    },
    {
      ...
      exchanges: [
        ...
        {
          ai: "Count any supply in your classroom! Say: There are ___ in my classroom",
    ...
    },
    {
      ...
      exchanges: [
        ...
        {
          ai: "The teacher writes on the board. Are there markers? Say: There are ___ markers",
        ...
        {
          ai: "End of day count! Tell me: what are there MANY of in the classroom? Say: There are many ___",
