export default {
  ...
  story_prompts: {
    picture_mode: {
      ...
      image_prompt: "Making a perfect sandwich step by step.",
      word_bank: ["grabbed two slices","soft bread","sharp knife","spread strawberry jam","pressed together","cut the sandwich","put it on","dinner plate","right sequence","disaster","follows its own","a dirty sock","beautiful"],
      writing_prompts: {
