const week11RealData = {
  ...
  nova_instructions: {
    ...
    opening_lines_by_mission: {
      mission_1: "Hi! I am Nova! I love going to fun places on weekends! Let's explore together! What do I call you? Say: My name is your name.",
  ...
  story_missions: [
    {
      ...
      story_character: {
        ...
        backstory: "Nova visits many fun places on weekends and wants to share them with students!",
    ...
    },
    {
      ...
      opening_narrative: "Hi! I'm Nova! Look! I PLAY at the park! What do you do at the park? Say: I play at the park!",
  ...
  spark_talk: [
    {
      ...
      seed_question: 'What is your favourite place? Is it the park or the library?',
      frames: [
        { template: 'I am at the ___', follow_up_q: 'Where are you? Are you at the park or at the school?', hints: ['park', 'school', 'library'] },
        { template: 'I am at the ___ with my friend', follow_up_q: 'Where are you and who is with you?', hints: ['park', 'school', 'library'] },
        { template: 'At the ___, I play', follow_up_q: 'What do you do at your favourite place?', hints: ['park', 'library', 'school'] },
        { template: 'At the ___, I feel happy', follow_up_q: 'How do you feel at your favourite place?', hints: ['park', 'library', 'school'] },
        { template: 'My favourite place is the ___', follow_up_q: 'What is your favourite place? The park or the library?', hints: ['park', 'library', 'playground'] },
        { template: 'I love being at the ___', follow_up_q: 'Where do you love being?', hints: ['park', 'beach', 'school'] },
        { template: 'At the ___, I love to run', follow_up_q: 'What do you love doing at your favourite place?', hints: ['park', 'library', 'beach'] },
        { template: 'I am happy at the ___', follow_up_q: 'Where are you happy? At the park or at home?', hints: ['park', 'school', 'home'] }
      ],
    ...
    },
    {
      ...
      seed_question: 'What did you do last weekend? Did you go out or stay at home?',
      frames: [
        { template: 'I was at the ___', follow_up_q: 'Where were you last weekend? At the park or at home?', hints: ['park', 'mall', 'beach'] },
        { template: 'At the ___, I played games', follow_up_q: 'What did you do there?', hints: ['park', 'mall', 'beach'] },
        { template: 'I was at the ___ with my family', follow_up_q: 'Who were you with last weekend?', hints: ['park', 'mall', 'home'] },
        { template: 'At the ___, I felt happy', follow_up_q: 'How did you feel? Were you happy or excited?', hints: ['park', 'mall', 'beach'] },
        { template: 'My favourite moment was at the ___', follow_up_q: 'What was your favourite moment? At the park or at home?', hints: ['park', 'beach', 'birthday party'] },
        { template: 'I was happy at the ___', follow_up_q: 'Where were you happiest last weekend?', hints: ['park', 'home', 'school'] },
        { template: 'At home, I ___', follow_up_q: 'What did you do at home last weekend?', hints: ['watched TV', 'played games', 'read a book'] },
        { template: 'I love going to the ___', follow_up_q: 'Where do you love going? The park or the beach?', hints: ['park', 'beach', 'library'] }
      ],
  ...
  conversation_cards: [
    {
      ...
      exchanges: [
        ...
        {
          ai: "Where do you read books? Say: I read at the library! or I read at school! or I read at home!",
        ...
        {
          ai: "Where do you see animals? At the zoo or at the park? Say: I see animals at the zoo! or I see animals at the at the zoo! or I see animals at the park!",
          fill_blank: "I see animals at the ___",
          accept_words: ["zoo", "at the zoo", "park"]
        },
        {
          ai: "Tell me one place you like! Say: I like the park! or I like the library! or I like the zoo!",
    ...
    },
    {
      ...
      exchanges: [
        ...
        {
          ai: "What do you do at the library? Say: I read at the library! or I study at the library!",
          fill_blank: "I ___ at the library",
          accept_words: ["read", "study", "read books"]
        },
        {
          ai: "What do you buy at the supermarket? Say: I buy food at the supermarket! or I buy milk at the supermarket! or I buy bread at the supermarket!",
          fill_blank: "I buy ___ at the supermarket",
          accept_words: ["food", "milk", "bread", "apples", "toys", "drinks"]
        },
        {
          ai: "Where do you study? At school or at home? Say: I study at school! or I study at home!",
          fill_blank: "I study at ___",
          accept_words: ["school", "home", "at school", "at home", "the library"]
        },
        {
          ai: "Tell me TWO things you do! Say: I play at the park and I read at the library! or I study at school and I play at home!",
    ...
    },
    {
      ...
      exchanges: [
        ...
        {
          ai: "What do you do there? Say: I play at the park! or I read at the library! or I see animals at the zoo! or I buy food at the supermarket!",
          options: ["I play at the park!", "I read at the library!", "I see animals at the zoo!", "I buy food at the supermarket!"]
        },
        {
          ai: "On Sunday where do you go? Say: On Sunday I go to the library! or On Sunday I go to the supermarket! or On Sunday I go to the restaurant!",
        ...
        {
          ai: "Great! Tell me your full Saturday plan! Say: On Saturday I go to the park and I play there! or On Saturday I go to the library and I read there!",
