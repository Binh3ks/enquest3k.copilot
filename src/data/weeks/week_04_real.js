  ...
  story_missions: [
    {
      ...
      objectives: [
          ...
          question_variants: [
            {
              ...
              hints: ["am", "I", "feeling", "happy", "today", "good"]
            },
            {
              question: "How do you feel right now?",
              hints: ["feel", "I", "happy", "good", "right", "now"]
            },
            {
              question: "Are you happy or sad today?",
              hints: ["I", "happy", "am", "today", "feeling", "good"]
            }
          ],
        ...
        },
        {
          ...
          question_variants: [
            {
              question: "Are you funny or friendly?",
              hints: ["I", "funny", "am", "friendly", "and"]
            },
            {
              question: "What are you like?",
              hints: ["am", "I", "funny", "friendly", "kind"]
            },
            {
              question: "Tell me about yourself.",
              hints: ["I", "am", "kind", "friendly", "funny"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["like", "I", "playing", "reading", "drawing"]
            },
            {
              question: "What is your favorite activity?",
              hints: ["favorite", "My", "is", "playing", "reading"]
            },
            {
              question: "What do you enjoy?",
              hints: ["enjoy", "I", "playing", "and", "reading"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["also", "like", "I", "drawing", "singing"]
            },
            {
              question: "Tell me another thing you enjoy.",
              hints: ["I", "enjoy", "also", "singing", "dancing"]
            },
            {
              question: "Do you like anything else?",
              hints: ["like", "I", "too", "dancing", "and", "singing"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["do", "I", "it", "after", "school", "everyday"]
            },
            {
              question: "What time do you play?",
              hints: ["play", "I", "in", "the", "morning", "afternoon"]
            },
            {
              question: "Is it morning or afternoon?",
              hints: ["It", "is", "in", "the", "afternoon", "morning"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["do", "I", "it", "with", "my", "friends", "mother"]
            },
            {
              question: "Do you play alone or with someone?",
              hints: ["play", "I", "with", "my", "friends", "alone"]
            },
            {
              question: "Who joins you?",
              hints: ["mother", "My", "joins", "me", "and", "father"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["favorite", "My", "is", "playing", "reading", "drawing"]
            },
            {
              question: "What do you love most?",
              hints: ["love", "I", "most", "playing", "with", "friends"]
            },
            {
              question: "Which activity do you like best?",
              hints: ["like", "I", "best", "reading", "and", "drawing"]
            }
          ],
        ...
        },
        {
          ...
          question_variants: [
            {
              question: "Why is that your favorite?",
              hints: ["Because", "it", "is", "fun", "I", "like", "it"]
            },
            {
              question: "What makes it special?",
              hints: ["makes", "It", "me", "happy", "and", "excited"]
            },
            {
              question: "Why do you love it?",
              hints: ["love", "I", "it", "because", "fun", "is", "it"]
            }
          ],
      ...
      objectives: [
        {
          ...
          question_variants: [
            {
              question: "What do you like doing?",
              hints: ["like", "I", "playing", "reading", "and", "drawing"]
            },
            {
              question: "Do you like playing or reading?",
              hints: ["like", "I", "playing", "and", "reading", "both"]
            },
            {
              question: "What is fun for you?",
              hints: ["is", "fun", "Playing", "for", "me", "and", "reading"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["play", "I", "games", "with", "my", "toys"]
            },
            {
              question: "What games do you like?",
              hints: ["like", "I", "hide", "and", "seek", "games"]
            },
            {
              question: "Tell me about your games.",
              hints: ["I", "play", "ball", "and", "tag", "games"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["favorite", "My", "game", "is", "hide", "and", "seek"]
            },
            {
              question: "Which game do you love?",
              hints: ["love", "I", "playing", "tag", "with", "friends"]
            },
            {
              question: "What game is the best?",
              hints: ["best", "The", "game", "is", "ball", "for", "me"]
            }
          ],
        ...
        },
        {
          ...
          question_variants: [
            {
              question: "How do you play that game?",
              hints: ["I", "run", "and", "jump", "to", "play"]
            },
            {
              question: "What do you do in the game?",
              hints: ["do", "I", "throw", "and", "catch", "the", "ball"]
            },
            {
              question: "Can you tell me about it?",
              hints: ["I", "hide", "and", "my", "friends", "find", "me"]
            }
          ],
        ...
        },
        {
          ...
          question_variants: [
            {
              question: "What books do you like reading?",
              hints: ["like", "I", "reading", "story", "books", "about", "animals"]
            },
            {
              question: "What kind of books do you read?",
              hints: ["read", "I", "fairy", "tale", "books", "and", "comics"]
            },
            {
              question: "Tell me about your books.",
              hints: ["books", "My", "are", "about", "adventure", "and", "animals"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["favorite", "My", "book", "is", "about", "animals"]
            },
            {
              question: "Which book do you love most?",
              hints: ["love", "I", "the", "fairy", "tale", "book", "most"]
            },
            {
              question: "What is the best book?",
              hints: ["best", "The", "book", "is", "the", "animal", "story"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["like", "I", "drawing", "animals", "and", "flowers"]
            },
            {
              question: "What do you draw?",
              hints: ["draw", "I", "my", "family", "and", "friends"]
            },
            {
              question: "Tell me what you draw.",
              hints: ["I", "draw", "houses", "animals", "and", "flowers"]
            }
          ],
        ...
        },
        {
          ...
          question_variants: [
            {
              question: "What colors do you use?",
              hints: ["use", "I", "red", "blue", "and", "green", "colors"]
            },
            {
              question: "Which colors do you like?",
              hints: ["like", "I", "yellow", "pink", "and", "purple"]
            },
            {
              question: "Tell me about your colors.",
              hints: ["colors", "My", "are", "blue", "green", "and", "red"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["like", "I", "singing", "and", "dancing", "both"]
            },
            {
              question: "What do you like - singing or dancing?",
              hints: ["I", "like", "dancing", "to", "music", "more"]
            },
            {
              question: "Are you good at singing or dancing?",
              hints: ["am", "I", "good", "at", "singing", "songs"]
            }
          ],
        ...
        },
        {
          ...
          question_variants: [
            {
              question: "Which activity is the most fun for you?",
              hints: ["most", "The", "fun", "is", "playing", "for", "me"]
            },
            {
              question: "What do you love doing most?",
              hints: ["love", "I", "reading", "books", "the", "most"]
            },
            {
              question: "What is your number one activity?",
              hints: ["number", "My", "one", "is", "drawing", "pictures"]
            }
          ],
    ...
    },
    {
      ...
      objectives: [
          ...
          question_variants: [
            {
              ...
              hints: ["makes", "happy", "me", "Playing", "friends", "with"]
            },
            {
              question: "Tell me something that makes you happy.",
              hints: ["happy", "makes", "me", "with", "Playing", "my", "family"]
            },
            {
              question: "What makes you feel happy?",
              hints: ["when", "happy", "feel", "I", "playing", "with", "friends"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["like", "also", "I", "reading", "drawing", "and"]
            },
            {
              question: "Tell me another happy thing.",
              hints: ["thing", "is", "Another", "singing", "happy", "dancing"]
            },
            {
              question: "What other thing makes you happy?",
              hints: ["happy", "makes", "thing", "Other", "is", "reading", "books"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["happy", "makes", "me", "My", "mother", "and", "father"]
            },
            {
              question: "Tell me about people who make you happy.",
              hints: ["happy", "me", "make", "My", "family", "and", "friends"]
            },
            {
              question: "Who do you feel happy with?",
              hints: ["with", "happy", "feel", "I", "my", "mother", "and", "friends"]
            }
          ],
        ...
        },
        {
          ...
          question_variants: [
            {
              question: "When are you very happy?",
              hints: ["happy", "very", "am", "I", "on", "my", "birthday"]
            },
            {
              question: "Tell me about a happy day.",
              hints: ["happy", "was", "My", "birthday", "party", "very"]
            },
            {
              question: "What day makes you happy?",
              hints: ["happy", "me", "makes", "My", "birthday", "party"]
            }
          ],
        ...
        },
        {
          ...
          question_variants: [
            {
              question: "Look! Your jar is full! How do you feel?",
              hints: ["feel", "happy", "I", "excited", "and", "proud"]
            },
            {
              question: "Your jar is full! Are you happy?",
              hints: ["happy", "am", "I", "Yes", "very", "excited"]
            },
            {
              question: "Wow! Your jar is full! Do you like it?",
              hints: ["like", "I", "Yes", "it", "very", "much"]
            }
          ],
        ...
        },
        {
          ...
          question_variants: [
            {
              question: "What is your favorite in the jar?",
              hints: ["favorite", "is", "My", "playing", "with", "family"]
            },
            {
              question: "What do you like most in your jar?",
              hints: ["like", "I", "most", "my", "family", "friends"]
            },
            {
              question: "Which thing in your jar is the best?",
              hints: ["best", "is", "the", "Family", "thing"]
            }
          ],
          ...
          question_variants: [
            {
              ...
              hints: ["like", "I", "it", "because", "fun", "is", "it"]
            },
            {
              question: "What makes you happy about it?",
              hints: ["happy", "me", "makes", "It", "fun", "because", "is", "it"]
            },
            {
              question: "Why is it good?",
              hints: ["good", "is", "It", "because", "fun", "very"]
            }
          ],
        ...
        },
        {
          ...
          question_variants: [
            {
              question: "Will you share your Happy Jar with your family?",
              hints: ["will", "I", "Yes", "share", "it", "with", "my", "family"]
            },
            {
              question: "Who will you show your jar to?",
              hints: ["show", "will", "I", "my", "jar", "to", "family", "and", "friends"]
            },
            {
              question: "Do you want to share your happiness?",
              hints: ["want", "I", "Yes", "to", "share", "my", "happiness"]
            }
          ],
      ...
      minimum_turns: 12,  // 8 main objectives + 2 student question invitations + 1 goodbye + buffer
      maximum_turns: 18,
