export default {
  ...
  hints: {
    vocabulary_bank: {
      ...
      words: [
        { word: "submarine", vi: "tàu ngầm", distractor: false },
        { word: "150", vi: "150", distractor: false },
        { word: "buoyancy", vi: "lực đẩy nổi", distractor: false },
        { word: "upward lift", vi: "lực nâng lên", distractor: false },
        { word: "displace", vi: "dịch chuyển nước", distractor: false },
        { word: "surface", vi: "bề mặt", distractor: false },
        { word: "compass", vi: "la bàn", distractor: false },
        { word: "museum", vi: "bảo tàng", distractor: false },
        { word: "airplane", vi: "máy bay", distractor: true },
        { word: "displaced", vi: "đã dịch chuyển", distractor: true },
        { word: "sinking", vi: "chìm xuống", distractor: true },
        { word: "skyscraper", vi: "tòa nhà cao tầng", distractor: true }
      ]
    }
  },
  story_prompts: {
