export default {
  ...
  keywords: ["excited and full of energy", "long difficult game", "team won the match", "helped my mother cook", "felt really proud", "history museum", "amazing historical things", "funny comedy movie", "laughed a lot", "sweet popcorn", "wonderful feelings"],
  ...
  hints: {
    vocabulary_bank: {
      ...
      words: [
        { "word": "excited and full of energy", "vi": "hào hứng và tràn đầy năng lượng", "distractor": false },
        { "word": "local park", "vi": "công viên gần nhà", "distractor": false },
        { "word": "team won the match", "vi": "đội thắng trận", "distractor": false },
        { "word": "rained heavily", "vi": "mưa to", "distractor": false },
        { "word": "helped my mother cook", "vi": "giúp mẹ nấu ăn", "distractor": false },
        { "word": "felt really proud", "vi": "cảm thấy rất tự hào", "distractor": false },
        { "word": "history museum", "vi": "bảo tàng lịch sử", "distractor": false },
        { "word": "amazing historical things", "vi": "những hiện vật lịch sử tuyệt vời", "distractor": false },
        { "word": "ancient weapons", "vi": "vũ khí cổ đại", "distractor": false },
        { "word": "funny comedy movie", "vi": "phim hài vui nhộn", "distractor": false },
        { "word": "laughed a lot", "vi": "cười rất nhiều", "distractor": false },
        { "word": "sweet popcorn", "vi": "bỏng ngô ngọt", "distractor": false },
        { "word": "wonderful feelings", "vi": "cảm xúc tuyệt vời", "distractor": false },
  ...
  story_prompts: {
    picture_mode: {
      ...
      word_bank: ["excited and full of energy", "local park", "team won the match", "rained heavily", "helped my mother cook", "felt really proud", "history museum", "amazing historical things", "ancient weapons", "funny comedy movie", "laughed a lot", "sweet popcorn", "wonderful feelings"],
      writing_prompts: {
      ...
      rubric_tier: 1,
      sentence_frames: [
        {"template": "It was Sunday afternoon when Leo ___", "answers": ["sat down with his pencils"]},
        {"template": "He had decided to create ___", "answers": ["a comic strip"]},
        {"template": "First, he drew ___", "answers": ["the characters"]},
        {"template": "Then he added ___", "answers": ["speech bubbles"]},
        {"template": "The first panel showed ___", "answers": ["a local park"]},
        {"template": "In the second panel, ___", "answers": ["it rained heavily"]},
        {"template": "The last panel showed ___", "answers": ["the team won the match"]},
