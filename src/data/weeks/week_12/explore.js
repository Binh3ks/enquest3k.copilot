export default {
  ...
  audio_narration: "/audio/week12/explore_narration.mp3",
  questions: [
    { q: "Which country is famous for flamenco dancing?", a: "Spain" },
    { q: "What sport do Brazilian children play with great skill?", a: "Football" },
    { q: "In which country do students practice calligraphy?", a: "Japan" }
  ]
};