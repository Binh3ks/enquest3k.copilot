export default {
  grammar_explanation: {
    ...
    rules: [
      { type: "rule", icon: "1️⃣", rule_en: "Use 'There is' to say something exists: There is a pen.", example_en: "There is a pencil in my bag. There is a ruler on the desk.", example_vi: "Có một cái bút chì trong túi của tôi. Có một cái thước trên bàn.", rule_vi: "Dùng 'There is' để nói có cái gì đó: There is a pen." },
      { type: "rule", icon: "2️⃣", rule_en: "Pattern: There is + a/an + [noun]", example_en: "There is a book. There is an eraser.", example_vi: "Có một cuốn sách. Có một cái tẩy.", rule_vi: "Cấu trúc: There is + a/an + [danh từ]" },
      { type: "rule", icon: "3️⃣", rule_en: "Question: Is there + a/an + [noun]? Answer: Yes, there is. / No, there isn't.", example_en: "Is there a pen? Yes, there is. Is there an eraser? No, there isn't.", example_vi: "Có bút không? Có. Có tẩy không? Không có.", rule_vi: "Câu hỏi: Is there + a/an + [danh từ]? Trả lời: Yes, there is. / No, there isn't." }
    ]
  },
  exercises: [
