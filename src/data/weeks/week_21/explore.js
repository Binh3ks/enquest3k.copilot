export default {
  title_en: "Science Field Journals: How Scientists Recorded the World",
  title_vi: "Nhật Ký Thực Địa: Cách Các Nhà Khoa Học Ghi Chép Thế Giới",
 ...
 **Every evening**, he opened his journal and wrote what he saw.
 ...
 `,
  ...
  check_questions: [
    {
      id: 1,
      question_en: "What did Charles Darwin record in his field journal during his voyage?",
      question_vi: "Charles Darwin đã ghi gì trong nhật ký thực địa trong chuyến hành trình?",
      answer: ["Animals, plants, and rocks", "What he saw on islands", "Observations of animals and plants"],
      hint_en: "He walked onto islands and looked at...",
      hint_vi: "Ông đã nhìn thấy..."
    },
    {
      id: 2,
      question_en: "How long did Jane Goodall watch chimpanzees in Africa?",
      question_vi: "Jane Goodall đã theo dõi tinh tinh ở châu Phi trong bao lâu?",
      answer: ["Over 60 years", "60 years", "More than 60 years"],
      hint_en: "She watched them for over...",
      hint_vi: "Bà đã theo dõi chúng trong hơn..."
    },
    {
      id: 3,
      question_en: "What important scientific idea did Darwin develop from his field journal?",
      question_vi: "Ý tưởng khoa học quan trọng nào Darwin phát triển từ nhật ký thực địa?",
      answer: ["The theory of evolution", "Theory of evolution", "Evolution"],
      hint_en: "His journal helped him develop the theory of...",
      hint_vi: "Nhật ký giúp ông phát triển lý thuyết..."
    }
  ],
  question: {
    text_en: "You are a scientist on a one-week expedition to a rainforest. What three things would you record in your field journal each day, and why are these observations important?",
    text_vi: "Bạn là nhà khoa học trong chuyến thám hiểm một tuần vào rừng nhiệt đới. Bạn sẽ ghi lại ba điều gì trong nhật ký thực địa mỗi ngày, và tại sao những quan sát này quan trọng?",
    min_words: 25,
    hint_en: "Yesterday, I walked into the forest and looked at... I watched... and listened to... because...",
    hint_vi: "Hôm qua, tôi đã đi vào rừng và nhìn thấy... Tôi đã theo dõi... và lắng nghe... vì..."
  }
};
...
export const dictionary = {
    ...
    'hundreds of years': { word: 'hundreds of years', pronunciation: '/hundreds of years/', definition_vi: 'hàng trăm năm', definition_en: 'meaning of hundreds of years', example: 'This is an example: hundreds of years.' },
    ...
    'local guides': { word: 'local guides', pronunciation: '/local guides/', definition_vi: 'local guides', definition_en: 'meaning of local guides', example: 'This is an example: local guides.' },
    ...
    'new page': { word: 'new page', pronunciation: '/new page/', definition_vi: 'trang mới', definition_en: 'Multi-word phrase: new page', example: 'The phrase \'new page\' is commonly used in conversation.' },
    ...
    'theory of evolution': { word: 'theory of evolution', pronunciation: '/theory of evolution/', definition_vi: 'theory of evolution', definition_en: 'meaning of theory of evolution', example: 'This is an example: theory of evolution.' },
