export default {
  ...
  keywords: ["walked", "talked", "listened", "notebook", "cleaned", "program", "diary", "proud"],
  topic_talk_prompt: "Tell me everything you did yesterday from morning to night!",
  sentence_frames: [
    {
        "template": "In the morning, I ___ to school with my best friend and we ___ about our favorite books.",
        "answers": [
            "walked",
            "talked"
        ]
    ...
    {
        "template": "In the evening, I ___ my room, ___ a short program, and then ___ at the bright stars.",
        "answers": [
            "cleaned",
            "watched",
            "looked"
