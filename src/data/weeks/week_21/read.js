export default {
  ...
  content_vi: "Thám tử Max tìm thấy cuốn nhật ký cũ của hôm qua. Cậu ấy mở nó ra và bắt đầu đọc.\n\nNhật ký thân mến, hôm qua là một ngày thật bận rộn và đẹp. Tôi dậy sớm, đánh răng và xếp đồ vào túi. Tôi đã đi bộ đến trường với bạn Lily, và chúng tôi đã nói chuyện suốt đường về bài tập khoa học. Buổi sáng lạnh nhưng chúng tôi đã cười cùng nhau và không cảm thấy gì.\n\nỞ trường, tôi đã lắng nghe cẩn thận giáo viên trong mỗi tiết học. Giờ ra chơi, tôi đã chơi bóng đá với các bạn và chúng tôi đã hét với hào hứng khi đội mình ghi bàn.\n\nSau giờ học, tôi đã giúp mẹ chuẩn bị bữa tối. Sau đó tôi đã dọn phòng và sắp xếp sách vở. Tôi đã rửa tay trước bữa ăn và đã xem chương trình yêu thích trong ba mươi phút.\n\nBuổi tối, tôi đã nhìn lên những vì sao qua cửa sổ phòng ngủ và đếm nhẹ mười ngôi. Tôi rất mệt, vì vậy tôi đã hoàn thành viết nhật ký và đã bắt đầu chìm vào giấc ngủ lúc chín giờ. Thật là một ngày bận rộn và đẹp!",
  audio_url: "/audio/week21/read_main.mp3",
  comprehension_questions: [
    { id: 1, question_en: "Did Max walk or take the bus to school?", answer: ["He walked", "Max walked to school", "He walked to school"], clue_statement: "Max walked to school.", hint_en: "He went to school on...", hint_vi: "Bạn ấy đến trường bằng...", audio_url: "/audio/week21/read_q1.mp3" },
    { id: 2, question_en: "What did Max do at break time?", answer: ["He played soccer", "He played football", "Played soccer"], clue_statement: "He played soccer.", hint_en: "He played...", hint_vi: "Bạn ấy đã chơi...", audio_url: "/audio/week21/read_q2.mp3" },
    { id: 3, question_en: "How many stars did Max count?", answer: ["Ten stars", "10 stars", "He counted ten stars"], clue_statement: "He counted ten stars.", hint_en: "He counted...", hint_vi: "Bạn ấy đếm được...", audio_url: "/audio/week21/read_q3.mp3" },
