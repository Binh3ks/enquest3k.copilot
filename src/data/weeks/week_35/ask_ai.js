// Cambridge A2 Flyers ask_ai.js — Week 35
export default {
  prompts: [
  {
    "id": 1,
    "title_en": "Situation 1: Main Story Inquiry",
    "context_en": "Ask Nova about the main event in Save Our Park — Environmental Action.",
    "context_vi": "Hỏi Nova về sự kiện chính trong bài Save Our Park — Environmental Action.",
    "sample_question_en": "What happened in the story of Save Our Park — Environmental Action?",
    "sample_question_vi": "Chuyện gì đã xảy ra trong câu chuyện Save Our Park — Environmental Action?",
    "answer": "What happened in the story of Save Our Park — Environmental Action?",
    "word_bank": [
      "What",
      "happened",
      "in",
  ...
  },
  {
    ...
    "context_en": "Ask Nova what main lesson students learn from Save Our Park — Environmental Action.",
    "context_vi": "Hỏi Nova bài học chính học sinh rút ra từ Save Our Park — Environmental Action.",
