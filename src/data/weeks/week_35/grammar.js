...
export default {
  ...
  exercises: [
    ...
    { id: 3, type: "fill_blank", question_en: "The Earth ___ get warmer if we do not stop pollution.", answer: "can", hint: "Khả năng xảy ra trong tương lai - CAN" },
    ...
    { id: 14, type: "fill_blank", question_en: "Polar ice ___ melt if global temperatures rise.", answer: "can", hint: "Khả năng - CAN" },
