// Pure Generated Writing Hub for Week 35
...
export const writingHub = {
  ...
  picture_story: {
    ...
    panels: [
      { image_url: "/images/week35/webtoon_scene_1.png", caption: "The mighty lion was sleeping peacefully under a tree." },
      { image_url: "/images/week35/webtoon_scene_4.png", caption: "Hunters trapped the lion in a heavy rope net." },
      { image_url: "/images/week35/webtoon_scene_5.png", caption: "The brave mouse chewed the ropes and freed the lion." }
    ],
    steps: [
      {
        scene: 1,
