export default {
  ...
  "sentence_frames": [
    {
      "template": "My name ___ Mia and ___ am a Time Detective.",
      "answers": [
        "is",
        "I"
      ]
    ...
    {
      "template": "I wear ___ big hat ___ carry a notebook to ask questions.",
      "answers": [
        "a",
        "and"
      ]
    ...
    {
      "template": "But someone ___ the cake ___ night.",
      "answers": [
        "ate",
        "last"
      ]
    ...
    {
      "template": "I asked ___ in the ___.",
      "answers": [
        "everyone",
        "house"
      ]
    ...
    {
      "template": "Dad said ___ cooked dinner ___ 6 o'clock and washed the dishes at 7.",
      "answers": [
        "he",
        "at"
      ]
    ...
    {
      "template": "Mum worked ___ the garden ___ morning last weekend.",
      "answers": [
        "in",
        "one"
      ]
    ...
    {
      "template": "The mystery ___ solved! My ___ ate the cake!.",
      "answers": [
        "was",
        "brother"
      ]
  ...
  "hints": {
    "vocabulary_bank": {
      ...
      "words": [
        ...
        {
          "word": "wrote down clues",
          "vi": "ghi lại manh mối",
          "distractor": false
        },
        {
          "word": "asked about last night",
          "vi": "hỏi về tối qua",
          "distractor": true
        },
        {
          "word": "found some evidence",
          "vi": "tìm bằng chứng",
          "distractor": true
        },
        {
          "word": "checked all the rooms",
          "vi": "kiểm tra phòng",
          "distractor": true
        }
      ]
  ...
  "story_prompts": {
    "picture_mode": {
      ...
      "sentence_frames": [
        {
          "template": "My name is Mia and I am a ___ ___",
          "answers": [
            "Time Detective",
            "then"
          ]
        ...
        {
          "template": "Yesterday, Mum cooked ___ ___",
          "answers": [
            "a chocolate cake",
            "so"
          ]
        ...
        {
          "template": "The mystery was ___ ___",
          "answers": [
            "solved",
            "carefully"
          ]
