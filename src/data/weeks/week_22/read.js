...
Cô ấy hỏi tiếp: "Anh/chị đã làm gì đêm qua và tuần trước?" Một lần nữa, nghi phạm trả lời mọi câu hỏi. Nova xem xét từng manh mối cẩn thận dưới ánh đèn lồng ấm áp.

Cuối cùng, Nova sắp xếp hồ sơ vụ án và viết báo cáo cuối cùng. Cô ấy trao báo cáo cho đội cảnh sát địa phương ở Hội An. Mọi manh mối trong sổ của cô đã giúp ích. Thám tử Nova đã giải quyết vụ án thêm một lần nữa.`,
  ...
  comprehension_questions: [
    ...
    },
    {
      ...
      hint_vi: "Nghi phạm đã trả lời...",
      audio_url: "/audio/week22/read_q2.mp3"
    },
    {
      id: 3,
      question_en: "What time expressions did Nova ask the suspect about?",
      answer: ["Yesterday morning and last week", "Yesterday and last week", "Yesterday morning, last night and last week"],
      clue_statement: "Yesterday morning, last night, and last week.",
    ...
    },
    {
      ...
      answer: ["The report", "Her final report", "The answer to the case"],
      clue_statement: "Nova gave her final report to her team at the end.",
