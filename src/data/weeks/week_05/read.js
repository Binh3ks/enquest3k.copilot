export default {
  ...
  comprehension_questions: [
    {
      id: 1,
      question_en: "Where is the mystery house?",
      answer: ["on the hill", "hill"],
      clue_statement: "The mystery house is on the hill.",
      hint_en: "It's high up...",
      hint_vi: "Nó ở trên cao..."
    },
    {
      id: 2,
      question_en: "What is upstairs?",
      answer: ["bedroom", "a bedroom", "nice bedroom"],
      clue_statement: "Upstairs is nice bedroom.",
      hint_en: "Where you sleep...",
      hint_vi: "Nơi bạn ngủ..."
    },
    {
      id: 3,
      question_en: "What is in the kitchen?",
      answer: ["cabinet", "fridge", "cabinet and fridge", "food", "drinks"],
      clue_statement: "There is cabinet and fridge in the kitchen.",
      hint_en: "Things to store food...",
      hint_vi: "Đồ để cất giữ thức ăn..."
    },
    {
      id: 4,
      question_en: "What is on the hill?",
      answer: ["a big house", "a big house", "There is a big house"],
      clue_statement: "There is a big house on the hill.",
      hint_en: "Look on the hill...",
      hint_vi: "Nhìn vào hill..."
    },
    {
      id: 5,
