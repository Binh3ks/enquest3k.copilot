...
export const dictionary = {
    ...
    'open the door': { word: 'open the door', pronunciation: '/open the door/', definition_vi: 'mở the door', definition_en: 'English phrase: open the door', example: 'The phrase \'open the door\' means mở the door.' },
