...
const week14RealData = {
  ...
  freetalk_knowledge: {
    ...
    example_opening_questions: [
      "Tell me about yourself! What is your name and how old are you?",
      "What is your favorite subject at school?",
      "What can you do? Are you good at something special?",
      "Tell me about your family! How many people are in your family?",
      "What do you like to do after school?",
      "If you could show one talent, what would you show?"
    ],
  ...
  spark_talk: [
    {
      ...
      seed_question: 'What is in your world? Is it your family or your school?',
      frames: [
        { template: 'I am ___', follow_up_q: 'How are you today? Are you happy or excited?', hints: ['happy', 'excited', 'a good student'] },
        { template: 'My world is ___', follow_up_q: 'What is your world like? Is it big or colourful?', hints: ['big', 'colourful', 'wonderful'] },
        { template: 'I can ___', follow_up_q: 'What can you do? Can you speak English or draw?', hints: ['speak English', 'draw', 'sing'] },
        { template: 'I like ___ing', follow_up_q: 'What do you like doing? Reading or playing?', hints: ['read', 'play', 'draw'] },
        { template: 'My favourite food is ___', follow_up_q: 'What is your favourite thing? Favourite food or place?', hints: ['pizza', 'noodles', 'rice and chicken'] },
        { template: 'There is a ___ in my world', follow_up_q: 'What is in your world? A favourite place or person?', hints: ['wonderful family', 'kind teacher', 'best friend'] },
        { template: 'I am at the ___', follow_up_q: 'Where are you? At school or at home?', hints: ['school', 'home', 'park'] },
        { template: 'I love my world because ___', follow_up_q: 'Why do you love your world?', hints: ['it has my family', 'it has my friends', 'it is wonderful'] }
      ],
    ...
    },
    {
      ...
      seed_question: 'What is near your home? Is there a park or a school?',
      frames: [
        { template: 'My neighbourhood is ___', follow_up_q: 'Is your neighbourhood big or quiet?', hints: ['big', 'quiet', 'busy'] },
        { template: 'There is a ___ in my neighbourhood', follow_up_q: 'What is in your neighbourhood? A park or a school?', hints: ['park', 'school', 'market'] },
        { template: 'I can ___ in my neighbourhood', follow_up_q: 'What can you do in your neighbourhood?', hints: ['play in the park', 'buy food at the market', 'meet my friends'] },
        { template: 'I like ___ in my neighbourhood', follow_up_q: 'What do you like doing in your neighbourhood?', hints: ['playing', 'riding', 'walking'] },
        { template: 'My favourite place in my neighbourhood is the ___', follow_up_q: 'What is your favourite place?', hints: ['park', 'playground', 'ice cream shop'] },
        { template: 'There are ___ people in my neighbourhood', follow_up_q: 'How many people are there? Many or a few?', hints: ['many', 'a lot of', 'kind'] },
        { template: 'My neighbour is ___', follow_up_q: 'What is your neighbour like? Kind or funny?', hints: ['kind', 'friendly', 'very nice'] },
        { template: 'I am happy in my neighbourhood because ___', follow_up_q: 'Why are you happy in your neighbourhood?', hints: ['there is a park', 'I have good friends', 'it is safe and quiet'] }
      ],
