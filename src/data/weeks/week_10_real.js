const week10RealData = {
  ...
  nova_instructions: {
    ...
    opening_lines_by_mission: {
      mission_1: "Hi! I am Ms. Nova! I love showing people the city AND the farm! They are very different! What do I call you? Say: My name is your name.",
  ...
  story_missions: [
    {
      ...
      story_character: {
        ...
        backstory: "Ms. Nova takes students on tours to compare city life with farm life!",
  ...
  conversation_cards: [
    {
      ...
      exchanges: [
        ...
        {
          ai: "Now use 'but' to contrast! Say: The city is noisy, but the farm is ___",
          fill_blank: "The city is noisy, but the farm is ___",
          accept_words: ["quiet", "the farm is quiet", "but", "farm"]
        },
        {
          ai: "Perfect! Try another one! Say: The city is busy, but the farm is ___",
          fill_blank: "The city is busy, but the farm is ___",
          accept_words: ["peaceful", "quiet", "calm", "but", "farm"]
        },
        {
          ai: "Great job! One more! Say: The farm is clean, but the city is ___",
    ...
    },
    {
      ...
      exchanges: [
        ...
        {
          ai: "Great! Now look! A bird that lays eggs! What do you see? Say: I see a ___",
    ...
    },
    {
      ...
      exchanges: [
        ...
        {
          ai: "Good choice! Why do you like it? Say: The ___ is ___",
          fill_blank: "The ___ is ___",
          accept_words: ["city", "farm", "quiet", "noisy", "peaceful", "busy", "clean", "is"]
        },
        {
          ai: "Nice! Now make a contrast sentence! Say: The ___ is ___, but the ___ is ___",
          accept: ["but", "city", "farm", "quiet", "noisy", "peaceful", "busy", "clean", "dirty"]
        },
        {
          ai: "Perfect contrast! What do you see in your favorite place? Say: I see ___",
