...
const week13RealData = {
  ...
  grammar_pattern: "I sing every day / I sing at [time]",
  ...
  story_missions: [
    {
      ...
      mission_context: `CRITICAL RULE: After EVERY student response you MUST: (1) ACKNOWLEDGE with "Great! You wake up at [time]!" echoing their sentence, (2) ask the NEXT question from the story arc, (3) give 2-3 hint choices: "Say: ___ or ___!". NEVER end without a question + choices. LAST TURN (turn 12) ONLY: short goodbye + what student learned. No more questions. GRAMMAR GUARD — WEEK 13 RULE: This week ONLY uses Present Simple tense. FORBIDDEN TENSES: NEVER use past tense (woke up, ate), NEVER use present perfect (have woken up), NEVER use future (will wake up) unless asking about plans. ONLY ALLOWED: I wake up, I brush my teeth, I eat breakfast, I go to school. Use PRESENT SIMPLE for routines. OPENING: Ask about THEIR morning routine: 'What time do you wake up? Say: I wake up at 7 o'clock!' Do NOT ask for the student's name — go straight to the routine topic. STORY: Focus on their morning activities — what time they wake up, what they eat for breakfast, how they get ready for school. VOCABULARY TARGET: wake up, brush teeth, eat breakfast, go to school, morning, time. GRAMMAR ENFORCEMENT: Every answer must use 'I sing' in present simple — recast naturally. FORBIDDEN: Do NOT ask about talents or abilities. This is about DAILY ROUTINES, not CAN/CAN'T. Do NOT use past tense at any point. Do NOT ask another question on the last turn.`,

      target_vocab: ["wake up", "brush teeth", "eat breakfast", "go to school", "morning"],
      grammar_pattern: "I sing at [time] / I sing every day",
...

    {
      ...
      mission_context: `CRITICAL RULE: After EVERY student response, you MUST (1) acknowledge briefly, (2) ask the NEXT question from the story, (3) give 2-3 hint choices: "Say: ___ or ___!" NEVER end a response without a question + choices. LAST TURN (turn 12) ONLY: short goodbye + what student learned. No more questions. This is Week 13 Mission 2 - My Perfect Day. STUDENT PROFILE: 6-12 years old Vietnamese children, A0+ level. CHARACTER: Nova helps student describe their full day from morning to night. OPENING: Ask "What do you do after school? Say: I play! or I do homework!" STRICT GAME RULES: 1. ONLY ask about daily routines and activities. 2. Student MUST say "I sing" in present simple. 3. If student gives yes/no only, prompt: "Say: I play with friends! or I watch TV!" 4. Ask about ONE activity per question. VOCABULARY TARGET: play, homework, dinner, watch TV, go to bed, evening, afternoon, night. ALLOWED QUESTIONS: "What do you do after school?", "When do you do homework?", "What do you eat for dinner?", "What time do you watch TV?", "What time do you go to bed?" GRAMMAR ENFORCEMENT: Every answer must practice "I sing" in present simple — recast all errors naturally. GAME MECHANIC: Go through the day chronologically → after school → homework → dinner → evening → bedtime. FORBIDDEN: Do NOT ask about abilities (can/can't). NEVER say 'Tell me more!', 'What do you want to talk about?', or 'I see!' as filler. AVOID: Complex sentences, multiple tasks per turn. Do NOT ask another question on the last turn.`,

      target_vocab: ["play", "do homework", "have dinner", "watch TV", "go to bed", "evening", "night"],
      grammar_pattern: "I sing after school / I sing in the evening",
  ...
  spark_talk: [
    {
      ...
      seed_question: 'What do you do first every morning? Do you brush your teeth or eat breakfast?',
      frames: [
        { template: 'I wake up at ___', follow_up_q: 'What time do you wake up? At six or seven?', hints: ['six o\'clock', 'half past six', 'seven o\'clock'] },
        { template: 'I eat ___ for breakfast', follow_up_q: 'What do you eat for breakfast?', hints: ['rice', 'bread', 'eggs'] },
        { template: 'I go to school at ___', follow_up_q: 'What time do you go to school?', hints: ['seven o\'clock', 'half past seven', 'eight o\'clock'] },
        { template: 'I brush my teeth every ___', follow_up_q: 'When do you brush your teeth? Every morning or every night?', hints: ['morning', 'night', 'morning and night'] },
        { template: 'I go to school with my ___', follow_up_q: 'Who do you go to school with?', hints: ['mum', 'dad', 'friend'] },
        { template: 'I have lunch at ___', follow_up_q: 'What time do you have lunch?', hints: ['twelve o\'clock', 'half past twelve', 'one o\'clock'] },
        { template: 'I do homework at ___', follow_up_q: 'When do you do homework? In the afternoon or the evening?', hints: ['four o\'clock', 'five o\'clock', 'six o\'clock'] },
        { template: 'I go to bed at ___', follow_up_q: 'What time do you go to bed?', hints: ['nine o\'clock', 'half past nine', 'ten o\'clock'] }
      ],
    ...
    },
    {
      ...
      seed_question: 'What is the perfect breakfast? Is it pancakes or eggs and bread?',
      frames: [
        { template: 'I wake up early and ___', follow_up_q: 'What is the first thing you do on a perfect day?', hints: ['have a big breakfast', 'go to the park', 'play with my friends'] },
        { template: 'I eat ___ for breakfast', follow_up_q: 'What is the perfect breakfast?', hints: ['pancakes', 'eggs and bread', 'fruit and juice'] },
        { template: 'I go to ___', follow_up_q: 'Where do you go on your perfect day?', hints: ['the park', 'the beach', 'the zoo'] },
        { template: 'I play ___ all day', follow_up_q: 'What do you play all day?', hints: ['football', 'games with my friends', 'in the garden'] },
        { template: 'I eat ___ for lunch', follow_up_q: 'What do you eat for lunch on a perfect day?', hints: ['pizza', 'noodles', 'my favourite food'] },
        { template: 'In the evening, I ___', follow_up_q: 'What do you do in the evening on a perfect day?', hints: ['watch a movie', 'play games', 'read a book'] },
        { template: 'I go to bed at ___', follow_up_q: 'When do you go to bed on a perfect day?', hints: ['ten o\'clock', 'nine o\'clock', 'late at night'] },
        { template: 'My perfect day has ___', follow_up_q: 'What one thing must a perfect day have?', hints: ['friends', 'good food', 'fun activities'] }
      ],
  ...
  conversation_cards: [
    {
      ...
      exchanges: [
        ...
        {
          ai: "Nice! What do you do first? Say: I brush my teeth first! or I wash my face first! or I eat breakfast first!",
          fill_blank: "I ___ first.",
          accept_words: ["brush my teeth", "wash my face", "eat breakfast", "get dressed", "brush teeth"]
        },
        {
          ai: "Great! What do you eat for breakfast? Say: I eat rice for breakfast! or I eat bread for breakfast! or I eat eggs for breakfast!",
          fill_blank: "I eat ___ for breakfast.",
          accept_words: ["rice", "bread", "eggs", "noodles", "cereal", "milk", "pho"]
        },
        {
          ai: "Yummy! What time do you go to school? Say: I go to school at 7 o'clock! or I go to school at 8 o'clock!",
    ...
    },
    {
      ...
      exchanges: [
        ...
        {
          ai: "Fun! What do you play? Say: I play soccer! or I play games! or I play with friends!",
          fill_blank: "I play ___.",
          accept_words: ["soccer", "games", "with friends", "basketball", "video games", "outside", "tag", "hide and seek"]
        },
        {
          ai: "What time do you do homework? Say: I do homework at 4 o'clock! or I do homework at 5 o'clock! or I do homework at 6 o'clock!",
          fill_blank: "I do homework at ___ o'clock.",
          accept_words: ["4", "5", "6", "7", "four", "five", "six", "seven"]
        },
        {
          ai: "What do you eat for dinner? Say: I eat rice for dinner! or I eat chicken for dinner! or I eat noodles for dinner!",
        ...
        {
          ai: "What time do you go to bed? Say: I go to bed at 8 o'clock! or I go to bed at 9 o'clock! or I go to bed at 10 o'clock!",
    ...
    },
    {
      ...
      exchanges: [
        {
          ai: "I'm a time detective! 🕐 What time do you wake up? Say: I wake up at 6 o'clock! or I wake up at 7 o'clock! or I wake up at 8 o'clock!",
          fill_blank: "I wake up at ___ o'clock.",
          accept_words: ["6", "7", "8", "six", "seven", "eight"]
        },
        {
          ai: "Good clue! What time do you eat breakfast? Say: I eat breakfast at 6 o'clock! or I eat breakfast at 7 o'clock! or I eat breakfast at 8 o'clock!",
          fill_blank: "I eat breakfast at ___ o'clock.",
          accept_words: ["6", "7", "8", "six", "seven", "eight"]
        },
        {
          ai: "What time do you go to school? Say: I go to school at 7 o'clock! or I go to school at 8 o'clock!",
          fill_blank: "I go to school at ___ o'clock.",
          accept_words: ["7", "8", "seven", "eight"]
        },
        {
          ai: "What time do you have lunch? Say: I have lunch at 11 o'clock! or I have lunch at 12 o'clock!",
