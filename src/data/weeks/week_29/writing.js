export default {
  ...
  sentence_frames: [{"template":"Last ___, my family went to ___."},{"template":"We went by ___. It took ___ hours."},{"template":"We saw ___ and ___. We also ___."},{"template":"My favourite memory was ___ because ___."}],
};
