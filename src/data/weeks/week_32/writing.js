export default {
  ...
  "sentence_frames": [
    ...
    {
      "template": "My mum/dad ___ I built ___ birdhouse.",
      "answers": [
        "and",
        "a"
      ]
  ...
  "story_prompts": {
    "picture_mode": {
      ...
      "word_bank": [
        "incredibly busy Saturday",
        "woke up at five o'clock",
        "completely tidied her bedroom",
        "old leather boots",
        "cut the long green grass",
        "built a beautiful birdhouse",
        "hung the birdhouse on a tree branch",
        "drank a warm cup of tea",
        "wrote a long letter",
        "chose soft cotton fabric",
        "make a brand new dress",
        "very tired but satisfied",
        "very active and independent",
        "admire her amazing energy"
      ],
      "writing_prompts": {
      ...
      "sentence_frames": [
        {
          "template": "Last Saturday, I woke up ___ ___",
          "answers": [
            "at five o'clock",
            "then"
          ]
        ...
        {
          "template": "First, I completely ___ ___",
          "answers": [
            "tidied my bedroom",
            "also"
          ]
        ...
        {
          "template": "Then I wrote a long ___ ___",
          "answers": [
            "letter",
            "so"
          ]
        ...
        {
          "template": "I helped Dad cut the ___ ___",
          "answers": [
            "long green grass",
            "next"
          ]
        ...
        {
          "template": "We built a beautiful ___ ___",
          "answers": [
            "birdhouse",
            "finally"
          ]
        ...
        {
          "template": "At the café, I chose ___ ___",
          "answers": [
            "a muffin",
            "slowly"
          ]
        ...
        {
          "template": "I paid with my own ___ ___",
          "answers": [
            "money",
            "happily"
          ]
        ...
        {
          "template": "By evening I felt very ___ ___",
          "answers": [
            "tired but satisfied",
            "carefully"
          ]
