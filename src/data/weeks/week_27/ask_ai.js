export default {
  ...
  prompts: [
    {
      id: 1,
      context_en: "Your friend puts a plant pot in a dark room with no windows. You want to warn them. Ask about what plants need.",
      context_vi: "Bạn của bạn đặt chậu cây trong phòng tối không có cửa sổ. Bạn muốn cảnh báo họ. Hỏi về điều cây cần.",
      answer: ["Can a plant survive without sunlight?", "Does a plant need sunlight to survive?", "What does a plant need to grow?"],
      hint: "Can a plant survive without sunlight?",
