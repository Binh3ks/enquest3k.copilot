export default {
  ...
  keywords: ["tiny seed", "good soil", "fresh water", "bright warm sun", "small hole", "strong root", "green stem", "warm sunlight", "broad green leaves", "bright yellow flower", "magical", "amazing life cycle"],
  ...
  sentence_frames: [
    ...
    },
    {
      ...
      "answers": ["stem", "sunlight"]
    },
    {
      "template": "The stem gets taller and stronger every single ___.",
      "answers": ["day"]
    },
    {
    ...
    {
      "template": "They help the plant catch the beautiful ___.",
      "answers": ["sunlight"]
    },
    {
  ...
  hints: {
    vocabulary_bank: {
      ...
      words: [
        { "word": "small hole", "vi": "lỗ nhỏ", "distractor": false },
        { "word": "dark ground", "vi": "đất tối", "distractor": false },
        { "word": "strong root", "vi": "rễ chắc", "distractor": false },
        { "word": "green stem", "vi": "thân xanh", "distractor": false },
        { "word": "warm sunlight", "vi": "ánh nắng ấm", "distractor": false },
        { "word": "broad green leaves", "vi": "lá xanh rộng", "distractor": false },
        { "word": "bright yellow flower", "vi": "bông hoa vàng rực", "distractor": false },
        { "word": "warm summer sun", "vi": "mặt trời mùa hè ấm áp", "distractor": false },
        { "word": "wonderful flower", "vi": "bông hoa tuyệt vời", "distractor": false },
        { "word": "shining sun", "vi": "mặt trời rực rỡ", "distractor": false },
        { "word": "magical", "vi": "thần kỳ", "distractor": false },
        { "word": "amazed and happy", "vi": "ngạc nhiên và vui", "distractor": false },
        { "word": "my own garden", "vi": "vườn của tôi", "distractor": false },
        { "word": "darkness", "vi": "bóng tối", "distractor": true },
        { "word": "freezing cold soil", "vi": "đất lạnh cóng", "distractor": true }
      ]
    }
  },
  story_prompts: {
    picture_mode: {
      ...
      word_bank: ["tiny seed", "small hole", "dark ground", "strong root", "green stem", "warm sunlight", "broad green leaves", "bright yellow flower", "warm summer sun", "wonderful flower", "my own garden", "magical", "amazed and happy"],
      writing_prompts: {
      ...
      rubric_tier: 1,
      sentence_frames: [
        {"template": "First, you plant a tiny ___", "answers": ["seed"]},
        {"template": "You put it in a small hole in the ___", "answers": ["dark ground"]},
        {"template": "After a few days, a strong ___", "answers": ["root grows"]},
        {"template": "Then a green ___", "answers": ["stem appears"]},
        {"template": "The plant needs warm ___", "answers": ["sunlight"]},
        {"template": "Soon, broad green ___", "answers": ["leaves grow"]},
        {"template": "Finally, a bright yellow ___", "answers": ["flower blooms"]},
        {"template": "The flower is truly ___", "answers": ["magical"]}
      ]
    }
  }
}
