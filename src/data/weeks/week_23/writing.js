export default {
  ...
  story_prompts: {
    picture_mode: {
      ...
      min_sentences: 8,
      sentence_frames: [
        {"template": "Yesterday I arrived at art class and ___", "answers": ["picked up my brush"]},
        {"template": "I dipped my brush into ___", "answers": ["red pigment"]},
        {"template": "I painted a picture of ___", "answers": ["red flowers"]},
        {"template": "I folded a sheet of paper into ___", "answers": ["a butterfly shape"]},
        {"template": "I used the scissors to ___", "answers": ["cut shapes"]},
        {"template": "I glued the leaves ___", "answers": ["around my picture"]},
        {"template": "I pressed each piece ___", "answers": ["carefully"]},
        {"template": "The teacher clapped ___", "answers": ["loudly and said it was wonderful"]}
      ]
    }
  }
}