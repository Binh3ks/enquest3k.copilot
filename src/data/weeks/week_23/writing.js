export default {
  ...
  min_words: 40,
  model_sentence: "Yesterday in art class I painted a picture of flowers. First I picked up my brush and dipped it into red pigment. Then I colored the petals carefully. I folded a piece of paper into a butterfly shape and checked the symmetry. Both sides looked the same! I cut small leaves with scissors and glued them around my picture to create a beautiful border. My teacher loved the texture and the colors I created.",
  instruction_en: "Write about what you did in an art class. Use regular past tense verbs.",
