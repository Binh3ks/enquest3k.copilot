export default {
  ...
  problems: [
    ...
    },
    {
      ...
      type: "comparison",
      cpa_stage: "pictorial",
      question_en: "The art room has 73 colored pencils and 46 crayons. How many more pencils than crayons are there?",
      ...
      solution_steps: ["Colored pencils: 73", "Crayons: 46", "Difference: 73 - 46 = ?"],
    ...
    },
    {
      ...
      type: "groups",
      cpa_stage: "pictorial",
      question_en: "There are 8 paint trays in the art room. Each paint tray has 5 color pots. How many color pots are there altogether?",
      ...
      solution_steps: ["Paint trays: 8", "Color pots per tray: 5", "Total: 5 + 5 + 5 + 5 + 5 + 5 + 5 + 5 = ?"],
      answer: ["40", "forty", "40 color pots"],
      unit: "color pots",
      hint_en: "Count 8 equal groups of 5 color pots.",
      hint_vi: "Đếm 8 nhóm bằng nhau, mỗi nhóm 5 lọ màu.",
      explanation_en: "5 x 8 = 40. There are 40 color pots altogether.",
      math_vocab: ["equal groups", "each tray", "total", "color pots"],
