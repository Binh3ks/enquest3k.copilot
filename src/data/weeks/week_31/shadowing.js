...
'I smelt, touched, could see, and tasted so many things!' Luna said. 'A **local market** is the best place for all five senses!'`,
  sentences: [
    ...
    { id: 2, text: "The old town market was colourful and busy." },
    ...
    { id: 5, text: "Luna picked up a heavy stone bowl. The stone felt cool and smooth." },
    { id: 6, text: "She touched a wooden shelf carved with leaf patterns. The wood felt rough and warm." },
    { id: 7, text: "Nearby, she felt soft cotton scarves and cold metal railings — so many different textures!" },
    { id: 8, text: "Luna smelt sweet strawberries and tasted a piece of mango." },
    { id: 9, text: "At the stall entrance, she heard the seller call out prices. A plastic bag broke with a loud noise!" },
    { id: 10, text: "'A local market is the best place for all five senses!'" }
  ]
};
