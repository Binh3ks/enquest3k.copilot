...
'I **smelt**, **touched**, could see, and **tasted** so many things!' Luna **said**. 'A **local market** is the best place for all five senses!'`,
  sentences: [
    ...
    { id: 2, text: "The old town market was very colourful and busy." },
    { id: 3, text: "Luna looked around and could see many different stalls." },
    { id: 4, text: "The light shone through the glass and made little rainbows." },
    { id: 5, text: "A friendly seller smiled at Luna and showed her a beautiful wooden sculpture." },
    { id: 6, text: "Luna picked up a heavy stone bowl. The stone felt cool and smooth." },
    { id: 7, text: "She touched a wooden shelf carved with leaf patterns. The wood felt rough and warm." },
    { id: 8, text: "Nearby, she felt soft cotton scarves and cold metal railings — so many different textures!" },
    { id: 9, text: "Luna smelt sweet strawberries and tasted a piece of mango." },
    { id: 10, text: "At the stall entrance, she heard the seller called out prices." },
    { id: 11, text: "A plastic bag broke with a loud noise!" }
  ]
};
