...
'Tôi ngửi, chạm, thấy, và nếm nhiều thứ!' Luna nói. 'Chợ là nơi tốt nhất cho tất cả năm giác quan!'`,
  sentences: [
    ...
    { id: 5, text: "Luna **picked up** a heavy stone bowl. The stone felt cool and smooth.", audio_url: "/audio/week31/dictation_s5.mp3" },
    { id: 6, text: "She touched a wooden shelf carved with leaf patterns. The wood felt rough and warm.", audio_url: "/audio/week31/dictation_s6.mp3" },
    { id: 7, text: "Nearby, she felt soft cotton scarves and cold metal railings — so many different textures!", audio_url: "/audio/week31/dictation_s7.mp3" },
    { id: 8, text: "Luna smelt sweet strawberries and tasted a piece of mango.", audio_url: "/audio/week31/dictation_s8.mp3" },
    { id: 9, text: "At the stall entrance, she heard the seller call out prices. A plastic bag broke with a loud noise!", audio_url: "/audio/week31/dictation_s9.mp3" },
    { id: 10, text: "'A **local market** is the best place for all five senses!'", audio_url: "/audio/week31/dictation_s10.mp3" }
  ]
};
