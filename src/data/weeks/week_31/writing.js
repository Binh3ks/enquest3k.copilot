export default {
  ...
  story_prompts: {
    picture_mode: {
      ...
      word_bank: ["traditional clothes made of cotton","shiny winter shoes made of leather","loud cheerful voices","friendly sellers calling out","heavy cooking pot made of metal","cold beautiful sculpture made of stone","cheap bright toys made of plastic","fragile glass on wooden table","fresh sweet flowers","juicy red apple","asked for the price","bought many delicious fruits","saw heard smelled and felt","incredibly colourful and noisy","amazing things to explore"],
      writing_prompts: {
        en: "Look at the picture. You are at a busy market with your mother. What do you see, hear, smell, and feel? Describe the colourful stalls and the things you notice using at least TWO materials words (cotton, metal, stone, plastic, glass, wood).",
        vi: "Nhìn bức tranh. Bạn ở chợ đông đúc với mẹ. Bạn thấy gì, nghe gì, ngửi gì và cảm nhận gì? Mô tả các sạp hàng sôi động và những điều bạn nhận thấy dùng ít nhất HAI từ vật liệu (cotton, metal, stone, plastic, glass, wood)."
      },
      rubric_tier: 2,
      sentence_frames: [
        {"template": "Last Sunday, I walked to the ___", "answers": ["busy market"]},
        {"template": "The stalls were full of ___", "answers": ["fresh fruit"]},
        {"template": "The sellers were wearing ___", "answers": ["traditional clothes"]},
        {"template": "I saw a heavy cooking pot made of ___", "answers": ["metal"]},
        {"template": "I also saw bright toys made of ___", "answers": ["plastic"]},
        {"template": "I picked up a juicy ___", "answers": ["red apple"]},
        {"template": "I asked for the ___", "answers": ["price"]},
        {"template": "The market was incredibly ___", "answers": ["colourful and noisy"]}
      ]
    }
  }
}