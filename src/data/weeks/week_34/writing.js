...
export default {
  ...
  sentence_frames: [
    {
      "template": "The first pig was ___ and ___, so he quickly built a ___ house using ___ paper and soft ___.",
      "answers": ["lazy","careless","weak","light","cotton"]
    },
    {
      "template": "The second pig ___ a bit harder than his brother, and he made his house with ___ plastic and ___ wood.",
      "answers": ["worked","thin","recycled"]
    },
    {
      "template": "The third pig, who was very ___ and ___, carefully put ___ stones, ___ metal, and ___ glass together to build a safe house.",
      "answers": ["smart","patient","heavy","strong","thick"]
    },
    {
      "template": "When the bad, ___ wolf finally came, he took a deep ___ and blew down the ___ house and the ___ house very easily!",
      "answers": ["hungry","breath","paper","wooden"]
    },
    {
      "template": "The two scared ___ ran as ___ as they could to their ___ brother's house.",
      "answers": ["pigs","fast","smart"]
    },
    {
      "template": "The angry wolf tried to blow down the third house, but no matter how ___ he tried, he could not ___ the strong stone ___.",
      "answers": ["hard","destroy","walls"]
    },
    {
      "template": "The three pigs safely stayed inside the strong house, locked the ___ metal ___ , and sang a ___ song.",
      "answers": ["heavy","door","happy"]
    },
    {
      "template": "The tired wolf finally gave ___ and ran away ___, and all the students clapped ___ for our great story!",
      "answers": ["up","forever","loudly"]
    }
  ],
  hints: {
    vocabulary_bank: {
  ...
  story_prompts: {
    picture_mode: {
      ...
      sentence_frames: [
        {"template": "The first pig was ___", "answers": ["lazy and careless"]},
        {"template": "He built a weak house from ___", "answers": ["light paper"]},
        {"template": "The second pig worked ___", "answers": ["harder"]},
        {"template": "He used recycled ___", "answers": ["wood and stones"]},
        {"template": "The third pig used ___", "answers": ["strong metal and thick glass"]},
        {"template": "The big bad wolf ___", "answers": ["blew down the first house"]},
        {"template": "The pigs ran and ___", "answers": ["locked the heavy door"]},
