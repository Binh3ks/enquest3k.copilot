...
export const writingHub = {
    ...
    steps: [
      {
        ...
        caption: "The mighty lion was resting under a shady green tree.",
        frame_L1: "In the beginning, the mighty lion was sleeping peacefully under a shady green tree.",
        ...
        audio: "On a sunny afternoon, the mighty lion was resting under a shady green tree."
      },
      {
        scene: 2,
        ladder_stage: "BUILD",
        ...
        caption: "Two hunters trapped the lion in a heavy net.",
        ...
        audio: "Suddenly, two hunters trapped the lion in a heavy net."
      },
      {
        scene: 3,
        ladder_stage: "WRITE",
        ...
        frame_L1: "Finally, the brave mouse chewed the thick ropes and freed the lion.",
  ...
  science_report_config: {
    ...
    data_card: [
      { subject: "🦁 Mighty Lion", action: "protected the forest territory", result: "kept other animals safe" },
      { subject: "🐭 Tiny Mouse", action: "planted new seeds in the ground", result: "helped new trees grow" },
      { subject: "🌳 Forest Trees", action: "gave food, shade and warm homes", result: "kept the ecosystem green" }
    ],
