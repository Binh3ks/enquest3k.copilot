export default {
  ...
  script: [
    ...
    { id: 3, text: "Every morning, I wake up early and get ready for school.", vi: "Mỗi buổi sáng, tôi thức dậy sớm và chuẩn bị đi học." },
    { id: 4, text: "My backpack is heavy because I carry my book and notebook every day.", vi: "Ba lô của tôi nặng vì tôi mang sách và vở mỗi ngày." },
    { id: 5, text: "In my classroom, there are twenty desks and one big whiteboard.", vi: "Trong lớp học, có hai mươi cái bàn và một bảng trắng lớn." },
    { id: 6, text: "My teacher, Ms. Johnson, is very kind and patient.", vi: "Cô giáo của tôi, cô Johnson, rất tốt bụng và kiên nhẫn." },
