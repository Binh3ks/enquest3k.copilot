export default {
  title: "My Happy Jar",
  videoId: "VnVMqbj96Z0",  // Feelings video (was: Fashion conversation)
  ...
  script: [
    ...
    { id: 2, text: "I have a happy jar at home.", vi: "Tôi có một chiếc hũ hạnh phúc ở nhà." },
    { id: 3, text: "Every day, I put happy things in my jar.", vi: "Mỗi ngày, tôi bỏ những thứ hạnh phúc vào hũ của mình." },
    { id: 4, text: "When I am playing with my dog, I feel excited.", vi: "Khi tôi chơi với con chó của mình, tôi cảm thấy phấn khích." },
    { id: 5, text: "When I am reading a good book, I feel calm and feel happy.", vi: "Khi tôi đọc một cuốn sách hay, tôi cảm thấy bình tĩnh và cảm thấy hạnh phúc." },
    { id: 6, text: "When I am drawing pictures, I feel creative.", vi: "Khi tôi vẽ tranh, tôi cảm thấy sáng tạo." },
    { id: 7, text: "My mom is friendly and funny.", vi: "Mẹ tôi rất thân thiện và hài hước." },
    { id: 8, text: "She makes me laugh every day.", vi: "Bà làm tôi cười mỗi ngày." },
