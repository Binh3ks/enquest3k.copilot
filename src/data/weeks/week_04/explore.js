  ...
  check_questions: [
    {
      ...
      hint_vi: "Nó bắt đầu bằng chữ 's'..."
    },
    {
      id: 2,
      question_en: "What sends signals to your body?",
      answer: ["brain", "your brain", "the brain"],
      hint_en: "It's in your head...",
      hint_vi: "Nó ở trong đầu bạn..."
    },
    {
      id: 3,
      question_en: "What is a smile chain?",
      answer: ["when you see someone smile you smile too", "smiling together", "everyone smiles"],
      hint_en: "When one person smiles, others...",
      hint_vi: "Khi một người cười, người khác..."
    }
  ],
  question: {
    text_en: "Why is smiling important? What happens when you smile?",
    text_vi: "Tại sao việc cười lại quan trọng? Điều gì xảy ra khi bạn cười?",
    min_words: 30,
