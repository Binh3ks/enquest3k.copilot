 ...
 * Strict Whitelist with Morphological Aliases (V-ing, V-ed, V-s, Plurals).
 * Professional ESL definitions, IPA, contextual examples, and alias mappings.
 */
...
export const WEEK_33_MASTER_DICTIONARY = {
  ...
  "call the school nurse": {
    ...
    aliases: [
      ...
      "calling the school nurse",
      "calls the school nurse"
    ]
  },
  "clean bandage": {
    type: "Collocation",
  ...
  "corridor": {
    ...
    audioText: "corridor",
    aliases: ["corridors", "hallway", "hallways"]
  },
  "slipped": {
    type: "Verb",
    ipa: "/slɪpt/",
  ...
  "recover": {
    ...
    audioText: "recover",
    aliases: ["recovers", "recovered", "recovering"]
  },
  "explain": {
    type: "Verb",
    ipa: "/ɪkˈspleɪn/",
    ...
    audioText: "explain",
    aliases: ["explains", "explained", "explaining"]
  },
  "lesson": {
    type: "Noun",
    ipa: "/ˈlɛsən/",
