...
export const listeningHubData = {
  ...
  listening_p1: {
    ...
    targets: [
      { id: 't1', label: 'Jake (Boy in blue shirt, walking carefully)', x: 22, y: 65, isExample: true },
      { id: 't2', label: 'School Nurse (White uniform, rushing with bandage)', x: 53, y: 62 },
      { id: 't3', label: 'Tom (Red shirt, slipping on wet floor)', x: 47, y: 68 },
      { id: 't4', label: 'Headmaster (Dark blue suit, near lockers)', x: 35, y: 55 },
      { id: 't5', label: 'Mia (Yellow top, holding mop)', x: 62, y: 64 }
    ]
  },
