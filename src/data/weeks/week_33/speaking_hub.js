...
export const speakingHub = {
  ...
  info_exchange_cards: {
    ...
    table_b: {
      ...
      subtitle: "Card 1: Information Card — Answer Examiner Nova's Questions",
      person: "Jake",
      fields: [
        {
          id: "field_b1",
          topic: "where / help?",
          cue_prompt: "where / help friend?",
          cue_word: "where",
          short_label: "where / help?",
          label: "where / help friend?",
        ...
        {
          id: "field_b2",
          topic: "what items / use?",
          cue_prompt: "what items / nurse use?",
          cue_word: "what",
          short_label: "what items / use?",
          label: "what items / nurse use?",
        ...
        {
          id: "field_b3",
          topic: "how fast / arrive?",
          cue_prompt: "how fast / nurse arrive?",
          cue_word: "how fast",
          short_label: "how fast / arrive?",
          label: "how fast / nurse arrive?",
        ...
        },
        {
          id: "field_b4",
          topic: "who / praise?",
          cue_prompt: "who / praise jake?",
          cue_word: "who",
          short_label: "who / praise?",
          label: "who / praise jake?",
        ...
        {
          id: "field_b5",
          topic: "what / safety rule?",
          cue_prompt: "what / safety rule?",
          cue_word: "what",
          short_label: "what / safety rule?",
          label: "what / safety rule?",
    ...
    dialogue_script: [
      { speaker: 'woman', text: "Now, let's practice asking and answering questions. Jake and Tom were involved in a school incident. I don't know anything about Jake's first aid action, but you do. So I'm going to ask you some questions." },
      { speaker: 'woman', text: "Where did Jake help his friend?" },
      { speaker: 'man',   text: "Near the science room." },
      { speaker: 'woman', text: "What first aid items did the nurse use?" },
      { speaker: 'man',   text: "A clean bandage and a cold pack." },
      { speaker: 'woman', text: "How fast did the school nurse arrive to help?" },
      { speaker: 'man',   text: "Within two minutes." },
      { speaker: 'woman', text: "Who praised Jake for his quick action?" },
      { speaker: 'man',   text: "The headmaster praised him in the school assembly." },
      { speaker: 'woman', text: "What safety rule did the headmaster remind all students?" },
      { speaker: 'man',   text: "Never run in school corridors." },
      { speaker: 'woman', text: "Now, you don't know anything about Tom's accident, so you ask me some questions." },
      { speaker: 'man',   text: "Where did Tom get injured?" },
      { speaker: 'woman', text: "He slipped in the school corridor near the science lab." },
      { speaker: 'man',   text: "What did he hurt?" },
      ...
      { speaker: 'man',   text: "Who helped Tom?" },
