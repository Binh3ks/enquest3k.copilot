...
export const speakingHub = {
  ...
  find_differences: {
    ...
    differences: [
      { id: "d1", name: "Warning Sign Shape", x: 26, y: 72, prompt_en: "In Picture A, the warning sign is tall and yellow, but in Picture B, it is smaller." },
      { id: "d2", name: "Wall Clock Time", x: 74, y: 22, prompt_en: "In Picture A, the clock shows ten o'clock, but in Picture B, it shows half past ten." },
      { id: "d3", name: "Student Bag Color", x: 48, y: 65, prompt_en: "In Picture A, the student bag is blue, but in Picture B, it is bright red." },
      { id: "d4", name: "First-Aid Box", x: 85, y: 40, prompt_en: "In Picture A, the first-aid box is on the wall, but in Picture B, it is missing." }
    ]
  }
};
