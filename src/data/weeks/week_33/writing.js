...
export default {
  ...
  sentence_frames: [
    ...
    {
      "template": "Jake told everyone: '___ ___ in the corridor or you might ___ and ___!'",
      "answers": ["Walk","slowly","fall","hurt yourself"]
    },
    {
      "template": "Now Jake always ___ carefully and never ___ in the corridor because he ___ his lesson.",
      "answers": ["walks","runs","learned"]
    }
  ],
  hints: {
    vocabulary_bank: {
  ...
  story_prompts: {
    picture_mode: {
      ...
      rubric_tier: 2,
      sentence_frames: [
        {"template": "Last week, Jake was running ___", "answers": ["very fast down the corridor"]},
        {"template": "He slipped on the ___", "answers": ["wet floor"]},
        {"template": "He fell down and ___", "answers": ["hit his left knee"]},
        {"template": "His arm and leg ___", "answers": ["hurt a lot"]},
        {"template": "He started ___", "answers": ["crying loudly"]},
        {"template": "His kind teacher ___", "answers": ["ran over to help"]},
        {"template": "She put a cold ___", "answers": ["ice pack on his knee"]},
        {"template": "Jake learned to ___", "answers": ["walk slowly and safely"]}
      ]
    }
  }
}