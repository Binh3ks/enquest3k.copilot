...
export default {
  ...
  exercises: [
    ...
    { id: 11, type: "fill_blank", question_en: "Jake ___ the paper by accident when he fell.", answer: "tore", hint: "tear-tore (xé)" },
    { id: 12, type: "fill_blank", question_en: "The dog ___ when it heard the loud noise.", answer: "shook", hint: "shake-shook (rung, lắc)" },
    ...
    { id: 16, type: "sentence_correct", question_en: "Correct the sentence: Jake hitted his knee on the table.", answer: "Jake hit his knee on the table", hint: "hit-hit is a zero-change verb — no -ed ending!" },
