export default {
  ...
  script: [
    ...
    { id: 8, text: "It is next to the bus stop.", vi: "Nó ở bên cạnh trạm xe buýt." },
    { id: 9, text: "A yellow bus stops near me.", vi: "Một chiếc xe buýt màu vàng dừng gần tôi." },
    { id: 10, text: "Many people get on the bus.", vi: "Nhiều người lên xe buýt." },
    { id: 11, text: "The traffic is heavy.", vi: "Giao thông đông đúc." },
    { id: 12, text: "Many vehicles move slowly.", vi: "Nhiều phương tiện di chuyển chậm." },
    { id: 13, text: "I see another street.", vi: "Tôi thấy một con phố khác." },
