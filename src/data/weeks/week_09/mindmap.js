const mindMapContent = {
  ...
  branchLabels: {
    "In the city I see ___.": [
      { text: "tall buildings", audio: "/audio/week9/mindmap_branch_r52lw.mp3" },
      { text: "busy streets", audio: "/audio/week9/mindmap_branch_phdvhl.mp3" },
      { text: "many cars", audio: "/audio/week9/mindmap_branch_2fyuyo.mp3" },
      { text: "big buses", audio: "/audio/week9/mindmap_branch_87nieq.mp3" },
      { text: "heavy traffic", audio: "/audio/week9/mindmap_branch_gqbucc.mp3" },
      { text: "modern buildings", audio: "/audio/week9/mindmap_branch_3p7wxu.mp3" }
    ],
    "In the city I hear ___.": [
      { text: "car horns", audio: "/audio/week9/mindmap_branch_yx0ttw.mp3" },
      { text: "people talking", audio: "/audio/week9/mindmap_branch_u9il7f.mp3" },
      { text: "bus engines", audio: "/audio/week9/mindmap_branch_9vjfan.mp3" },
      { text: "noisy traffic", audio: "/audio/week9/mindmap_branch_vmo2yz.mp3" },
    ...
    "I can ride a ___.": [
      ...
      { text: "car", audio: "/audio/week9/mindmap_branch_23tg.mp3" },
      { text: "taxi", audio: "/audio/week9/mindmap_branch_245cu.mp3" },
      { text: "bicycle", audio: "/audio/week9/mindmap_branch_1y4001.mp3" },
