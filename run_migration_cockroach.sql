-- ============================================================
-- CockroachDB Migration Script for EngQuest3K
-- Run this in CockroachDB SQL Shell BEFORE redeploying
-- ============================================================
...
-- STEP 3: Add missing columns to STATION_PROGRESS table
...
-- Backfill station_key from station_id
