...
**Scaffolded Difficulty Standard — see full 156-Week Scaffolding Map below.**

**Count rule:**
- W16-W54 (Phase 1): 5 problems/week
- W55-W120 (Phase 2): 7 problems/week
- W121-W156 (Phase 3): 10 problems/week
...
**Diagram Rule (W16+):**
- Use the correct diagram type for the math domain — bar models are only ONE option.
- Diagram types supported by `generate_logiclab_barmodels.py`:
  - `part_whole` → classic part-whole bar
  - `comparison` → two bars with difference arrow
  - `missing_part` → whole bar with known + unknown box
  ...
  - `rectangle_area` / `rectangle_perimeter` → labelled rectangle
  - `triangle_area` → right triangle with base & height labels
  - `circle_area` / `circle_circumference` → circle with radius label
  - `number_line` → number line with marked points
  - `clock_time` → analogue clock face
  - `bar_chart` → simple 2–4 bar chart for data problems
  - `coordinate_grid` → 2-quadrant grid for coordinates/lines
  - `pythagoras` → right triangle with sides a, b, c labelled
  - `no_diagram` → leave `bar_model: ""` — generator skips this problem
- Keep deterministic naming: `barmodel_wNN_{adv|easy}_p{1-5}_v1.jpg`
- Use versioned files (`_vN.jpg`) whenever a bar model is regenerated.
- Ensure every non-empty `bar_model` path resolves to a real image before release.
...
## 📊 SINGAPORE MATH 156-WEEK SCAFFOLDING MAP

> **Rationale**: EngQuest is not bound by a single school grade. Every week introduces math vocabulary in English regardless of classroom grade. Content progresses from Primary 1 foundations (W16) through Secondary 4 level (W156) so students are always learning English inside meaningful, age-appropriate mathematics.

> **Key rule**: The math domain changes every 3-week block. Theme (travel, nature, food…) must **embed** the math naturally — travel weeks do time/distance problems, food weeks do measurement/fraction problems, etc.

### Legend for diagram column:
`pw`=part_whole · `cmp`=comparison · `mp`=missing_part · `grp`=groups · `ba`=before_after · `frac`=fraction_bar · `rect`=rectangle_area/perimeter · `tri`=triangle_area · `circ`=circle · `nl`=number_line · `clk`=clock_time · `chart`=bar_chart · `coord`=coordinate_grid · `pyth`=pythagoras · `∅`=no_diagram

### PHASE 1 — Foundational (W16–W54) · 5 problems/week

| Weeks | P-Level | Math Domain | Key Concepts | Recommended diagram types | Problem types (all 5 per set) |
|-------|---------|-------------|--------------|--------------------------|-------------------------------|
| W16–W18 | P1 | Whole-number addition & subtraction ≤20 | Part-whole model; number bonds; "How many altogether / left?" | pw · cmp · mp · grp · ba | part_whole · comparison · missing_part · groups · before_after |
| W19–W21 | P1→P2 | Addition & subtraction ≤100; place value tens/ones | Regrouping; carrying; "How many more?" | pw · cmp · mp · ba · grp | part_whole · comparison · missing_part · before_after · groups |
| W22–W24 | P2 | Multiplication as equal groups (×2, ×5, ×10) | Repeated addition; array model; "How many in all?" | grp · pw · cmp · mp · ba | groups · part_whole · comparison · missing_part · before_after |
| W25–W27 | P2 | Division as equal sharing; inverse of ×2, ×5, ×10 | "Share equally"; finding group size; remainder = 0 | grp · mp · pw · cmp · ba | groups · missing_part · part_whole · comparison · before_after |
| W28–W30 | P2 | Fractions of a whole — ½, ¼, ⅓ | Shade fraction of shape; fraction of a set; comparing simple fractions | frac · pw · cmp · mp · ∅ | fraction_bar · part_whole · comparison · missing_part · no_diagram |
| W31–W33 | P2 | Money — cents & dollars, simple change | Reading price tags; total cost; giving change | pw · cmp · ba · mp · ∅ | part_whole · comparison · before_after · missing_part · no_diagram |
| W34–W36 | P2→P3 | Time — o'clock, half-past, quarter past/to; duration | Reading analogue clock; elapsed time; a.m./p.m. | clk · ba · cmp · pw · ∅ | clock_time · before_after · comparison · part_whole · no_diagram |
| W37–W39 | P3 | Measurement — length (cm/m), mass (g/kg), volume (ml/l) | Measuring & comparing; unit conversion (simple) | pw · cmp · mp · ba · ∅ | part_whole · comparison · missing_part · before_after · no_diagram |
| W40–W42 | P3 | Multiplication tables ×3, ×4, ×6; 2-digit × 1-digit | Standard algorithm; "rows × columns"; area model intro | grp · pw · cmp · mp · ba | groups · part_whole · comparison · missing_part · before_after |
| W43–W45 | P3 | Division with remainders; 2-digit ÷ 1-digit | "Remainder" language; check with multiplication | grp · mp · pw · cmp · ba | groups · missing_part · part_whole · comparison · before_after |
| W46–W48 | P3 | Fractions — equivalent fractions; ½=2/4; comparing with same denominator | Fraction wall; ordering fractions; improper intro | frac · pw · cmp · mp · ∅ | fraction_bar · part_whole · comparison · missing_part · no_diagram |
| W49–W51 | P3 | Perimeter of rectangles, squares, composite (L-shape) | Add all sides; formula P=2(l+w); unknown side | rect · cmp · pw · mp · ∅ | rectangle_perimeter · comparison · part_whole · missing_part · no_diagram |
| W52–W54 | P3→P4 | Area — square centimetre; counting squares; Area=l×w | "How many squares fit?"; unit cm²; compare areas | rect · cmp · pw · grp · ∅ | rectangle_area · comparison · part_whole · groups · no_diagram |

### PHASE 2 — Academic Application (W55–W120) · 7 problems/week

| Weeks | P-Level | Math Domain | Key Concepts | Recommended diagram types |
|-------|---------|-------------|--------------|--------------------------|
| W55–W57 | P4 | Large numbers to 100,000; factors & multiples | Place value chart; prime numbers ≤20; divisibility rules | pw · cmp · mp · grp · ba · ∅ · ∅ |
| W58–W60 | P4 | Multiplication tables ×7, ×8, ×9; 3-digit × 1-digit | Long multiplication; word problems using × language | grp · pw · cmp · mp · ba · ∅ · ∅ |
| W61–W63 | P4 | Fractions — mixed numbers; improper; +/− same denominator | Mixed number ↔ improper conversion; number line fractions | frac · nl · pw · cmp · mp · ba · ∅ |
| W64–W66 | P4 | Decimals (1–2 decimal places); money; rounding | Place value to hundredths; compare decimals; $dollars.cents | nl · pw · cmp · ba · mp · ∅ · ∅ |
| W67–W69 | P4 | Geometry — angles (acute/obtuse/reflex); symmetry | Identify angle types; line of symmetry; protractor intro | ∅ · cmp · pw · ∅ · ∅ · ∅ · ∅ |
| W70–W72 | P4 | Parallel & perpendicular lines; quadrilateral properties | Square, rectangle, rhombus, parallelogram; angle properties | rect · cmp · pw · mp · ∅ · ∅ · ∅ |
| W73–W75 | P4 | Area & perimeter of composite figures (L, T, U shapes) | Split into rectangles; add/subtract areas; find missing sides | rect · cmp · mp · pw · ∅ · ∅ · ∅ |
| W76–W78 | P4 | Statistics — bar graphs with scale; tables; basic average | Read scales; total ÷ count = mean; "most popular" | chart · cmp · pw · mp · ∅ · ∅ · ∅ |
| W79–W81 | P4→P5 | Multi-step word problems (2 operations) | "First… then…" multi-step; choose operation; check answer | pw · cmp · mp · grp · ba · ∅ · ∅ |
| W82–W84 | P5 | Fractions × whole number; fractions ÷ whole number | ¾ × 8 = 6; word problems "He used ⅓ of 12 apples" | frac · pw · cmp · mp · nl · ∅ · ∅ |
| W85–W87 | P5 | Percentage — fraction ↔ %; find % of a quantity | 25% = ¼; "What is 30% of 60?"; percentage increase | nl · pw · cmp · frac · ba · ∅ · ∅ |
| W88–W90 | P5 | Ratio (2-part) — part:part; part:whole; equivalent ratios | 3:2 ratio; scale model; "Divide 20 in ratio 3:2" | pw · cmp · mp · ba · ∅ · ∅ · ∅ |
| W91–W93 | P5 | Speed — Distance = Speed × Time | "How far in 3 hours at 60 km/h?"; average speed | ba · cmp · pw · mp · ∅ · ∅ · ∅ |
| W94–W96 | P5 | Triangle — area = ½ × base × height; angle sum 180° | Identify base & height; acute/obtuse/right triangles | tri · rect · cmp · pw · ∅ · ∅ · ∅ |
| W97–W99 | P5 | Volume of cuboids; nets of 3D shapes | V = l × w × h; surface area concept; cm³ | rect · pw · cmp · grp · ∅ · ∅ · ∅ |
| W100–W102 | P5 | Data — mean, median, mode, range | Ordered list; middle value; most common; spread | chart · pw · cmp · ∅ · ∅ · ∅ · ∅ |
| W103–W105 | P5→P6 | Multi-step ratio problems; 3-part ratios; before-after model | "Ratio changed after…"; model method for unknowns | pw · ba · cmp · mp · ∅ · ∅ · ∅ |
| W106–W108 | P6 | Percentage — discount, GST, profit & loss, percentage change | Original price → sale price; % profit formula | ba · cmp · pw · frac · ∅ · ∅ · ∅ |
| W109–W111 | P6 | Circles — circumference = 2πr; area = πr² | Identify radius/diameter; π ≈ 3.14; semicircles | circ · cmp · pw · ∅ · ∅ · ∅ · ∅ |
| W112–W114 | P6 | Algebra — model method → symbolic; simple linear equations | "Think of a number…"; x + 5 = 12; form & solve | pw · mp · ba · cmp · ∅ · ∅ · ∅ |
| W115–W117 | P6 | Algebra — simultaneous (model method with 2 unknowns) | Total + difference → find each; fraction of unknown | pw · mp · cmp · ba · ∅ · ∅ · ∅ |
| W118–W120 | P6 | Volume — compound 3D shapes; rates (litres per minute) | Cuboid + smaller cuboid; flow rate = volume ÷ time | rect · pw · cmp · ba · ∅ · ∅ · ∅ |

### PHASE 3 — Advanced Synthesis (W121–W156) · 10 problems/week

| Weeks | Level | Math Domain | Key Concepts | Recommended diagram types |
|-------|-------|-------------|--------------|--------------------------|
| W121–W123 | Sec1 | Integers — negative numbers; number line; operations | −3 + 7; subtract negatives; temperature changes | nl · cmp · pw · ba · mp · ∅ · ∅ · ∅ · ∅ · ∅ |
| W124–W126 | Sec1 | Linear equations — ax + b = c; substitution | Solve for x; check by substitution; worded equations | pw · mp · ba · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ |
| W127–W129 | Sec1 | Geometry expanded — angle relationships; polygons | Angles on a line, in a triangle, vertically opposite | ∅ · cmp · pw · mp · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ |
| W130–W132 | Sec1 | Pythagoras theorem — finding hypotenuse and legs | a²+b²=c²; identify right triangle; real contexts | pyth · rect · cmp · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ |
| W133–W135 | Sec1 | Statistics — histograms; cumulative frequency | Draw & read histograms; "how many below 50?" | chart · pw · cmp · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ |
| W136–W138 | Sec2 | Coordinate geometry — gradient; y = mx + b | Plot points; find gradient; interpret y-intercept | coord · cmp · pw · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ |
| W139–W141 | Sec2 | Trigonometry — sin, cos, tan in right triangles | TOA-CAH-SOH mnemonic; find angle or side | pyth · tri · cmp · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ |
| W142–W144 | Sec2 | Probability — experimental vs theoretical; combined events | P(event) = favourable ÷ total; tree diagrams; AND/OR | ∅ · ∅ · cmp · pw · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ |
| W145–W147 | Sec2 | Sequences — arithmetic & geometric; nth term | "Find the 10th term"; general formula an = a + (n−1)d | nl · ∅ · cmp · pw · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ |
| W148–W150 | Sec2 | Quadratic expressions — expand & factorise (simple) | (x+3)(x+2); x²+bx+c; FOIL method | ∅ · ∅ · ∅ · pw · cmp · ∅ · ∅ · ∅ · ∅ · ∅ |
| W151–W153 | Sec3 | Circle theorems — angle at centre; angle in semicircle | Tangent, chord, arc; sector area; arc length | circ · ∅ · cmp · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ |
| W154–W156 | Sec3/4 | Multi-step challenge problems — mixed domains | Combine algebra + geometry + statistics; worded proofs | mixed · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ · ∅ |

---

### Diagram-Type → bar_model value reference

When writing `singapore_math.js`, set `bar_model` to:
- A file path `"/images/weekNN/barmodel_wNN_{adv|easy}_pN_v1.jpg"` for any generated diagram
- `""` (empty string) for `no_diagram` problems — the generator will skip them
- The `type` field drives which draw function is called in `generate_logiclab_barmodels.py`

```
type: "part_whole"           → draw_part_whole()
type: "comparison"           → draw_comparison()
type: "missing_part"         → draw_missing()
type: "groups"               → draw_groups()
type: "before_after"         → draw_before_after()
type: "fraction_bar"         → draw_fraction_bar()
type: "rectangle_area"       → draw_rectangle()   (shows area formula)
type: "rectangle_perimeter"  → draw_rectangle()   (shows perimeter formula)
type: "triangle_area"        → draw_triangle()
type: "circle_area"          → draw_circle()
type: "circle_circumference" → draw_circle()
type: "number_line"          → draw_number_line()
type: "clock_time"           → draw_clock()
type: "bar_chart"            → draw_bar_chart()
type: "coordinate_grid"      → draw_coordinate_grid()
type: "pythagoras"           → draw_pythagoras()
type: "no_diagram"           → SKIPPED (bar_model: "" required)
```
